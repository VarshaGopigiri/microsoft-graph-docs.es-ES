...
Para obtener más información sobre cómo llegar a los archivos en carpetas de OneDrive, consulte el [tipo de recurso DriveItem](https://developer.microsoft.com/es-ES/graph/docs/api-reference/v1.0/resources/driveitem) en la documentación de referencia.
...
Puede probar esta consulta con su cuenta de OneDrive cargando el archivo demo.xlsx a su carpeta raíz de OneDrive y ejecutando la consulta en el [Probador de Microsoft Graph](https://developer.microsoft.com/es-ES/graph/graph-explorer).

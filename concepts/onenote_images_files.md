...
Use `img` con `src="http://image-url"` y especifique la dirección URL de una imagen de acceso público. Representa la imagen en la página de OneNote.
...
Use `img` con `data-render-src="http://webpage-url"` y especifique la dirección URL de una página web. Representa una instantánea de la página web completa en la página de OneNote.

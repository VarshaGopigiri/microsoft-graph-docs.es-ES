...
- Todas las solicitudes GET empiezan con la [dirección URL raíz de servicio](../api-reference/v1.0/resources/onenote-api-overview.md#root-url). <br/><br/>**Ejemplos**: `https://www.onenote.com/api/v1.0/me/notes` y `https://www.onenote.com/api/v1.0/myOrganization/siteCollections/{id}/sites/{id}/notes/`

...
| _offline_access_ |    Acceso a los datos de usuario en cualquier momento (versión preliminar) | Permite que la aplicación lea y actualice los datos del usuario, incluso cuando no están usando en ese momento la aplicación.| No |
| _openid_ |    Iniciar la sesión de los usuarios (versión preliminar) | Permite que los usuarios inicien sesión en la aplicación con sus cuentas profesionales o educativas y permite que la aplicación vea la información básica del perfil del usuario.| No |

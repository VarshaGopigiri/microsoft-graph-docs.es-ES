...
| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
|Adición |beta| Introdujo [API riskyUsers](/graph/api/resources/riskyuser?view=graph-rest-beta), que representa a los usuarios de Azure AD que están en riesgo, como detecte mediante la protección de la identidad de AD de Azure. |
...
| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
|Cambio   |beta| Cambiar el nombre de la propiedad `conditionalAccessPolicies` a `appliedConditionalAccessPolicy`.|
|Adición |beta| Introdujo propiedades adicionales de riesgo en la [API de inicio de sesión](/graph/api/resources/signin?view=graph-rest-beta), incluidos `riskDetail`, `riskLevelAggregated`, `riskLevelDuringSignIn`, `riskEventTypes`, y `riskState`.|
|Adición |beta| Introdujo propiedades de inicio de inicio de sesión adicionales en la [API de inicio de sesión](/graph/api/resources/signin?view=graph-rest-beta), incluidos `authenticationProcessingDetails`, `originalRequestID`, `isInteractive`, `tokenIssuerName`, `tokenIssuerType`, `correlationId`, y `processingTimeinMilliseconds`.|
|Eliminación   |beta| Quita la propiedad `isRisky`.|
...
| **Tipo de cambio** | **Versión** | **Descripción**                  |
|:------------|:--------|:-----------------------------------------|
| Adición    | Beta   | Se ha agregado un [consulta delta](delta-query-overview.md) capacidad para [directoryObject](/graph/api/directoryobject-delta?view=graph-rest-beta) |
| Cambio      | V1.0 y beta  | Comportamiento alternativo para devolver las propiedades modificadas sólo en la respuesta JSON para [los usuarios](/graph/api/user-delta?view=graph-rest-1.0) y [grupos](/graph/api/group-delta?view=graph-rest-1.0). |
| Adición    | v1.0   | Se agregó la función [delta](/graph/api/directoryrole-delta?view=graph-rest-1.0) para [directoryRole](/graph/api/resources/directoryrole?view=graph-rest-1.0) admitir el [uso de consulta de delta de seguimiento de cambios](delta-query-overview.md). |

### <a name="directory-apis"></a>API de directorio

| **Tipo de cambio** | **Versión**   | **Descripción**                          | 
| :-------------- | :------------ | :--------------------------------------- | 
| Adición | Beta | Agrega la propiedad **licenseAssignmentStates** a la entidad de [usuario](/graph/api/resources/user?view=graph-rest-beta) para [Licencias en función de grupo](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-licensing-whatis-azure-portal).|
| Adición | Beta | Agrega el recurso **licenseAssignmentState** para [Licencias en función de grupo](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-licensing-whatis-azure-portal).| 
| Adición | Beta | Agrega las propiedades **assignedLicenses**, **licenseProcessingState**, **hasMembersWithLicenseErrors** y **membersWithLicenseErrors** a la entidad de [grupo](/graph/api/resources/group?view=graph-rest-beta) para el [Grupo en función de licencias](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-licensing-whatis-azure-portal).|
...
|Adición|v1.0|Se agregó la propiedad **v12_0** para el tipo complejo [iosMinimumOperatingSystem](/graph/api/resources/intune-apps-iosminimumoperatingsystem?view=graph-rest-1.0)|
...
|Adición|beta|Se agregó la función [getManagedDevicesWithAppFailures](/graph/api/intune-troubleshooting-user-getmanageddeviceswithappfailures?view=graph-rest-beta) de [usuario](/graph/api/resources/intune-devices-user?view=graph-rest-beta) |
...
|Eliminación|beta|Quita la propiedad **subjectAlternativeNameType** de la entidad [androidForWorkCertificateProfileBase](/graph/api/resources/intune-deviceconfig-androidforworkcertificateprofilebase?view=graph-rest-beta)|
...
|Adición|beta|Agrega las propiedades **certificateStore**, **customSubjectAlternativeNames** y **subjectAlternativeNameType** a la entidad [androidForWorkScepCertificateProfile](/graph/api/resources/intune-deviceconfig-androidforworkscepcertificateprofile?view=graph-rest-beta)|
|Eliminación|beta|Quita la propiedad **subjectAlternativeNameType** de la entidad [androidWorkProfileCertificateProfileBase](/graph/api/resources/intune-deviceconfig-androidworkprofilecertificateprofilebase?view=graph-rest-beta)|
...
|Adición|beta|Agrega las propiedades **certificateStore**, **customSubjectAlternativeNames** y **subjectAlternativeNameType** a la entidad [androidWorkProfileScepCertificateProfile](/graph/api/resources/intune-deviceconfig-androidworkprofilescepcertificateprofile?view=graph-rest-beta)|
...
|Eliminación|beta|Quita la propiedad **pinRequiredOnLaunchInsteadOfBiometric** de la entidad [managedAppProtection](/graph/api/resources/intune-mam-managedappprotection?view=graph-rest-beta)|
...
|Adición|beta|Se agregó la **engagedRestartDeadlineInDays**, **engagedRestartSnoozeScheduleInDays**, **engagedRestartTransitionScheduleInDays**, **autoRestartNotificationDismissal**, **scheduleRestartWarningInHours** y ** scheduleImminentRestartWarningInMinutes** las propiedades de la entidad [windowsUpdateForBusinessConfiguration](/graph/api/resources/intune-deviceconfig-windowsupdateforbusinessconfiguration?view=graph-rest-beta)|
|Adición|beta|Agrega las propiedades **preSharedKey** y **meteredConnectionLimit** a la entidad [windowsWifiConfiguration](/graph/api/resources/intune-deviceconfig-windowswificonfiguration?view=graph-rest-beta)|
|Adición|beta|Agrega la propiedad de navegación **intuneBrandingProfiles** a la entidad [deviceManagement](/graph/api/resources/intune-androidforwork-devicemanagement?view=graph-rest-beta)|
|Adición|beta|Agrega las propiedades **v6_0**, **v7_0**, **v7_1**, **v8_0**, **v8_1** y **v9_0** para el tipo complejo [androidMinimumOperatingSystem](/graph/api/resources/intune-apps-androidminimumoperatingsystem?view=graph-rest-beta)|
|Adición|beta|Se agregó la propiedad **v12_0** para el tipo complejo [iosMinimumOperatingSystem](/graph/api/resources/intune-apps-iosminimumoperatingsystem?view=graph-rest-beta)|
|Eliminación|beta|Quita la propiedad **runAsLoggedOnUser** de tipo complejo [win32LobAppPowerShellScriptDetection](/graph/api/resources/intune-apps-win32lobapppowershellscriptdetection?view=graph-rest-beta)|
|Adición|beta|Se agregó la propiedad **lastUpdateDateTime** para el tipo complejo [osVersionCount](/graph/api/resources/intune-devices-osversioncount?view=graph-rest-beta)|
|Adición|beta|Se agregó la propiedad **lastUpdateDateTime** para el tipo complejo [windowsMalwareCategoryCount](/graph/api/resources/intune-devices-windowsmalwarecategorycount?view=graph-rest-beta)|
|Adición|beta|Se agregó la propiedad **lastUpdateDateTime** para el tipo complejo [windowsMalwareExecutionStateCount](/graph/api/resources/intune-devices-windowsmalwareexecutionstatecount?view=graph-rest-beta)|
|Adición|beta|Se agregó la propiedad **lastUpdateDateTime** para el tipo complejo [windowsMalwareNameCount](/graph/api/resources/intune-devices-windowsmalwarenamecount?view=graph-rest-beta)|
|Adición|beta|Se agregó la propiedad **lastUpdateDateTime** para el tipo complejo [windowsMalwareStateCount](/graph/api/resources/intune-devices-windowsmalwarestatecount?view=graph-rest-beta)|

### <a name="privileged-identity-management-apis"></a>API de Privileged Identity Management

| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Cambio | beta | Cambio de la entidad [privilegedapproval](/graph/api/resources/privilegedapproval?view=graph-rest-beta) .|
| Adición | beta | Se agregó la entidad [privilegedroleassignmentrequest](/graph/api/resources/privilegedroleassignmentrequest?view=graph-rest-beta) y siguientes métodos y acciones:<br> [Lista](/graph/api/privilegedroleassignmentrequest-list?view=graph-rest-beta) <br> [Create](/graph/api/privilegedroleassignmentrequest-post?view=graph-rest-beta) <br> [Cancel](/graph/api/privilegedroleassignmentrequest-cancel?view=graph-rest-beta) <br> [My](/graph/api/privilegedroleassignmentrequest-my?view=graph-rest-beta) |
| Adición | beta | Se ha agregado un [actualización](/graph/api/privilegedrolesettings-update?view=graph-rest-beta) para [privilegedRoleSettings](/graph/api/resources/privilegedrolesettings?view=graph-rest-beta)|
| Eliminación |beta| En desuso el [Activar asignación de roles](/graph/api/privilegedrole_selfactivate?view=graph-rest-beta)|

### <a name="microsoft-teams-apis"></a>API de Microsoft Teams

| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
|Adición|beta|Agrega compatibilidad con los permisos de aplicación a [archivo equipo](/graph/api/team-archive?view=graph-rest-beta) y [unarchive equipo](/graph/api/team-unarchive?view=graph-rest-beta) API.|

### <a name="outlook-contacts"></a>Contactos de Outlook

| **Tipo de cambio** | **Versión** | **Descripción**                          |
| :-------------- | :---------- | :--------------------------------------- |
| Eliminación         | v1.0        | Se trata de una corrección en la documentación: quita la propiedad del **indicador** del tema de la entidad [de contactos](/graph/api/resources/contact?view=graph-rest-1.0) . La propiedad nunca se puso a disposición de la entidad de **contactos** .|

### <a name="reports-apis"></a>API de informes
| Tipo de cambio | Versión | Descripción                              |
|:------------|:--------|:-----------------------------------------|
| Adición    | v1.0    | Agrega la propiedad de **Identificador de sitio** a [getSharePointSiteUsageDetail](/graph/api/reportroot-getsharepointsiteusagedetail?view=graph-rest-1.0). |

## <a name="september-2018"></a>Septiembre de 2018

### <a name="calls-and-online-meetings-api"></a>Las llamadas y API de reuniones en línea

| **Tipo de cambio** | **Versión** | **Descripción**                          |
| :-------------- | :---------- | :--------------------------------------- |
| Cambio          | Beta        | El recurso de la [aplicación](/graph/api/resources/application?view=graph-rest-beta) se actualizó para agregar una colección de las llamadas. |
| Cambio          | Beta        | El recurso de la [operación](/graph/api/resources/operation?view=graph-rest-beta) se actualizó para admitir las llamadas y reuniones API de larga duración. |
| Adición        | Beta        | Agrega el recurso [de llamadas](/graph/api/resources/call?view=graph-rest-beta) para la administración de las llamadas de audio y vídeo (inicialmente, en Microsoft Teams), incluidas las API para la [creación de las llamadas](/graph/api/application-post-calls?view=graph-rest-beta), [recuperar un una llamada](/graph/api/call-get?view=graph-rest-beta), [Eliminar (colgar) una llamada](/graph/api/call-delete?view=graph-rest-beta), [responder a una llamada](/graph/api/call-answer?view=graph-rest-beta), [rechazar un llamar a](/graph/api/call-reject?view=graph-rest-beta), [redirigir una llamada](/graph/api/call-redirect?view=graph-rest-beta)y [transferir una llamada](/graph/api/call-transfer?view=graph-rest-beta). Asimismo, hemos agregado API para admitir [escenarios IVR](/graph/api/resources/calls-api-ivr-overview?view=graph-rest-beta): [reproducir un símbolo del sistema](/graph/api/call-playprompt?view=graph-rest-beta), [grabación de una llamada](/graph/api/call-record?view=graph-rest-beta), [Cancelar de procesamiento de medios](/graph/api/call-cancelmediaprocessing?view=graph-rest-beta)y [suscribirse a la entrada táctil tonos a las notificaciones](/graph/api/call-subscribetotone?view=graph-rest-beta). |
| Adición        | Beta        | Se agregó el recurso [participante](/graph/api/resources/call?view=graph-rest-beta) y API para administrar a los participantes en las llamadas de audio y vídeo y reuniones, incluida la [recuperación de un objeto participante](/graph/api/participant-get?view=graph-rest-beta), [Configurar el Mezclador de audio de un participante](/graph/api/participant-configuremixer?view=graph-rest-beta), silenciar el audio [uno](/graph/api/participant-mute?view=graph-rest-beta) o [todos los ](/graph/api/participant-muteall?view=graph-rest-beta)de los participantes, la [recuperación de una lista de los participantes](/graph/api/call-list-participants?view=graph-rest-beta) en una llamada o reunión e [Invitar a participantes](/graph/api/participant-invite?view=graph-rest-beta) a una reunión de llamada. |
| Adición        | Beta        | Se ha agregado un API para aplicaciones para administrar y participar en las llamadas y las reuniones, incluida la capacidad para [compartir contenido](/graph/api/call-changescreensharingrole?view=graph-rest-beta), [desactivar y reactivar el audio de sí mismo](/graph/api/call-unmute?view=graph-rest-beta)y [actualizar los metadatos asociados con una llamada](/graph/api/call-updatemetadata?view=graph-rest-beta). |
| Adición        | Beta        | Se agregó el recurso de [grupo de enrutamiento de audio](/graph/api/resources/audioroutinggroup?view=graph-rest-beta) y la API para la administración de rutas de audioconferencias privadas entre los participantes en una conversación con varios participantes, incluidas la [creación de grupos de enrutamiento de audioconferencias](/graph/api/call-post-audioroutinggroups?view=graph-rest-beta), la [recuperación de una lista de ellos](/graph/api/audioroutinggroup-get?view=graph-rest-beta)y la [actualización](/graph/api/audioroutinggroup-update?view=graph-rest-beta) y [eliminación de](/graph/api/audioroutinggroup-delete?view=graph-rest-beta) ellos. |
| Adición        | Beta        | Agrega las API y los recursos de la [reunión en línea](/graph/api/resources/audioroutinggroup?view=graph-rest-beta) para la administración de reuniones en línea de Microsoft Teams. Inicialmente, no hay sólo una API para reuniones en línea, para [recuperar un objeto de la reunión en línea](/graph/api/onlinemeeting-get?view=graph-rest-beta). También se ha agregado un recurso relacionado para obtener la [información de conferencia de audio](/graph/api/resources/audioconferencing?view=graph-rest-beta) asociado a una reunión (por ejemplo, dirección URL de acceso telefónico, códigos de acceso y números de teléfono). |
| Adición        | Beta        | Muchas de las llamadas y reuniones API tardan en completarse, por lo que se agregaron los recursos para estas operaciones de larga duración: [operaciones específicas de la llamada](/graph/api/resources/commsoperation?view=graph-rest-beta), [reproducir mensajes de audio](/graph/api/resources/playpromptoperation?view=graph-rest-beta)y [grabación](/graph/api/resources/recordoperation?view=graph-rest-beta).  |

### <a name="dynamics-365-business-central-api"></a>API de Dynamics 365 empresarial Central

| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Adición        | Beta          | Se ha agregado un financials API para Dynamics 365 empresarial Central. Para obtener información detallada, vea la [referencia de la API de gestión financiera](/graph/api/resources/dynamics-graph-reference?view=graph-rest-beta)

### <a name="microsoft-graph-data-connect"></a>Conexión de datos de Microsoft Graph

| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
|Adición         | No disponible| Introdujo la posibilidad de obtener acceso a datos de Office 365 de forma masiva. Para obtener información detallada, vea [Conectar (vista previa) de datos de Microsoft Graph](data-connect-overview.md).|
...
|Adición|beta|Se agregó la acción [asignar](/graph/api/intune-cirrus-officeclientconfiguration-assign?view=graph-rest-beta) en [officeClientConfiguration](/graph/api/resources/intune-cirrus-officeclientconfiguration?view=graph-rest-beta) |
|Adición|beta|Se agregó la acción **updatePrioritie** en colección [officeClientConfiguration](/graph/api/resources/intune-cirrus-officeclientconfiguration?view=graph-rest-beta) |
...
|Adición|beta|Se agregó la acción **getTargetedUsersAndDevices** en colección [deviceConfiguration](/graph/api/resources/intune-deviceconfig-deviceconfiguration?view=graph-rest-beta) |
...
|Eliminación|beta|Quita la propiedad **restrictedApps** de la entidad [androidForWorkCompliancePolicy](/graph/api/resources/intune-deviceconfig-androidforworkcompliancepolicy?view=graph-rest-beta)|
|Eliminación|beta|Quita la propiedad **restrictedApps** de la entidad [androidWorkProfileCompliancePolicy](/graph/api/resources/intune-deviceconfig-androidworkprofilecompliancepolicy?view=graph-rest-beta)|
|Cambio|beta|Cambiar las siguientes propiedades de la entidad [appleVpnConfiguration](/graph/api/resources/intune-deviceconfig-applevpnconfiguration?view=graph-rest-beta) :<br/>**enablePerApp** de requerido a opcional<br/>|
|Adición|beta|Agrega las propiedades **disableProtectionOfManagedOutboundOpenInData** y **protectInboundDataFromUnknownSources** a la entidad [defaultManagedAppProtection](/graph/api/resources/intune-mam-defaultmanagedappprotection?view=graph-rest-beta)|
...
|Adición|beta|Se agregó la **kioskModeBlockVolumeButtons**, **classroomForceRequestPermissionToLeaveClasses**, **keychainBlockCloudSync**, **pkiBlockOTAUpdates**, **privacyForceLimitAdTracking**, ** enterpriseBookBlockBackup**, **enterpriseBookBlockMetadataSync**, **airPrintBlocked**, **airPrintBlockCredentialsStorage**, **airPrintForceTrustedTLS**, **airPrintBlockiBeaconDiscovery**, ** blockSystemAppRemoval** y las propiedades de **vpnBlockCreation** a la entidad [iosGeneralDeviceConfiguration](/graph/api/resources/intune-deviceconfig-iosgeneraldeviceconfiguration?view=graph-rest-beta)|
|Adición|beta|Agrega las propiedades **disableProtectionOfManagedOutboundOpenInData** y **protectInboundDataFromUnknownSources** a la entidad [iosManagedAppProtection](/graph/api/resources/intune-mam-iosmanagedappprotection?view=graph-rest-beta)|
...
|Adición|beta|Agrega las propiedades **keychainBlockCloudSync**, **airPrintBlocked**, **airPrintForceTrustedTLS** y **airPrintBlockiBeaconDiscovery** a la entidad [macOSGeneralDeviceConfiguration](/graph/api/resources/intune-deviceconfig-macosgeneraldeviceconfiguration?view=graph-rest-beta)|
|Adición|beta|Agrega las propiedades **deviceModel** y **entradas deviceManufacturer** a la entidad [managedAppRegistration](/graph/api/resources/intune-mam-managedappregistration?view=graph-rest-beta)|
...
|Adición|beta|Agrega las propiedades de navegación **deviceConfigurationConflictSummary** y **importedWindowsAutopilotDeviceIdentityUploads** a la entidad [deviceManagement](/graph/api/resources/intune-shared-devicemanagement?view=graph-rest-beta)|
|Adición|beta|Agrega la propiedad de navegación **intendedDeploymentProfile** a la entidad [windowsAutopilotDeviceIdentity](/graph/api/resources/intune-enrollment-windowsautopilotdeviceidentity?view=graph-rest-beta)|
|Adición|beta|Agrega las propiedades **startLayoutTileSize** y el **nombre** para el tipo complejo [windowsKioskAppBase](/graph/api/resources/intune-deviceconfig-windowskioskappbase?view=graph-rest-beta)|
|Adición|beta|Agrega las propiedades **desktopApplicationId** y **desktopApplicationLinkPath** para el tipo complejo [windowsKioskDesktopApp](/graph/api/resources/intune-deviceconfig-windowskioskdesktopapp?view=graph-rest-beta)|
|Eliminación|beta|Quita la propiedad **name** de tipo complejo [windowsKioskDesktopApp](/graph/api/resources/intune-deviceconfig-windowskioskdesktopapp?view=graph-rest-beta)|
|Adición|beta|Se agregó la propiedad **disallowDesktopApps** para el tipo complejo [windowsKioskMultipleApps](/graph/api/resources/intune-deviceconfig-windowskioskmultipleapps?view=graph-rest-beta)|
|Cambio|beta|Cambiar las siguientes propiedades en el tipo complejo [windowsKioskMultipleApps](/graph/api/resources/intune-deviceconfig-windowskioskmultipleapps?view=graph-rest-beta) :<br/>**startMenuLayoutXml** de requerido a opcional<br/>|
|Adición|beta|Agrega las propiedades **v10_1607**, **v10_1703**, **v10_1709** y **v10_1803** para el tipo complejo [windowsMinimumOperatingSystem](/graph/api/resources/intune-apps-windowsminimumoperatingsystem?view=graph-rest-beta)|
|Adición|beta|Se agregó al miembro **paloAltoGlobalProtect** para el tipo de enumeración [androidWorkProfileVpnConnectionType](/graph/api/resources/intune-deviceconfig-androidworkprofilevpnconnectiontype?view=graph-rest-beta)|
|Adición|beta|Se agregó al miembro **remoteLock** para el tipo de enumeración [deviceComplianceActionType](/graph/api/resources/intune-deviceconfig-devicecomplianceactiontype?view=graph-rest-beta)|
...
| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
|Adición|beta|Se ha agregado un API para [las fichas](/graph/api/resources/teamstab?view=graph-rest-beta).|
|Adición|beta|Se ha agregado un API de [publicación de aplicaciones para la organización](/graph/api/resources/teamsapp?view=graph-rest-beta).|
|Adición|beta|Permisos de la aplicación se ha agregado un soportan para [obtener /teams/ {identificador}](/graph/api/team-get?view=graph-rest-beta). |
|Adición|beta|Agrega compatibilidad con los permisos de aplicación a [GET /teams/ {identificador} / canales](/graph/api/group-list-channels?view=graph-rest-beta). |
|Adición|beta|Permisos de la aplicación se ha agregado un soportan para [obtener /teams/ {identificador} /channels/ {identificador}](/graph/api/channel-get?view=graph-rest-beta). |
|Adición|beta|Permisos de la aplicación se ha agregado un soportan para [poner /groups/ {identificador} / equipo](/graph/api/team-put-teams?view=graph-rest-beta). |
|Adición|beta|Agrega compatibilidad con los permisos de aplicaciones a [una revisión /teams/ {identificador}](/graph/api/team-update?view=graph-rest-beta). |
|Adición|beta|Se agregó aplicación compatible con permisos para [Crear canal](/graph/api/channel-post?view=graph-rest-beta), [canal de actualización](/graph/api/channel-patch?view=graph-rest-beta)y [eliminación de canal](/graph/api/channel-delete?view=graph-rest-beta). |
|Eliminación|beta| Se ha quitado propiedades isBlocks y installedState desde [teamsApp](/graph/api/resources/teamsapp?view=graph-rest-beta).|
|Cambio| beta | La propiedad context en [teamsApp](/graph/api/resources/teamsapp?view=graph-rest-beta) ha cambiado de nombre a distributionMethod.|

### <a name="outlook-mail"></a>Correo de Outlook

| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Adición        | V1.0 y beta | La propiedad **internetMessageHeaders** de la entidad de [mensaje](/graph/api/resources/message?view=graph-rest-1.0) ahora es grabable en la creación del mensaje. |


### <a name="project-rome-notifications-api"></a>API de notificaciones de Roma de Project

| **Tipo de cambio** | **Versión** | **Descripción**                          |
| :-------------- | :---------- | :--------------------------------------- |
| Adición          | Beta        | Se agregó el tipo de recurso de [notificación](/graph/api/resources/projectrome-notification?view=graph-rest-beta) . |
| Adición          | Beta        | Se agregó el [crear y publicar notificación] (/ gráfico, api/projectrome_notification_post? vista = Gráfico-rest-beta) API.|

### <a name="security-apis"></a>API de seguridad

| **Tipo de cambio** | **Versión** | **Descripción**              |
| :-------------- | :---------- | :--------------------------------------- |
| Adición        | Beta       | Agrega las API de puntuación de seguro a la [API de seguridad](/graph/api/resources/securescore-api-overview?view=graph-rest-beta), incluidos los recursos y las operaciones siguientes:<br/>[secureScores](/graph/api/resources/securescores?view=graph-rest-beta) (y las entidades relacionadas)<br/>[Lista secureScores](/graph/api/securescores-list?view=graph-rest-beta)<br/>[secureScoreControlProfiles](/graph/api/resources/securescorecontrolprofiles?view=graph-rest-beta)<br/>[Lista secureScoreControlProfiles](/graph/api/securescorecontrolprofiles-list?view=graph-rest-beta)<br/>[Actualizar secureScoreControlProfiles](/graph/api/securescorecontrolprofiles-update?view=graph-rest-beta)


### <a name="onedrive-and-sharepoint-apis"></a>OneDrive y las API de SharePoint

| **Tipo de cambio** | **Versión** | **Descripción**                          |
| :-------------- | :---------- | :--------------------------------------- |
| Adición        | Beta        | Se agregó el argumento **deferCommit** para la acción [createUploadSession](/graph/api/driveitem-createuploadsession?view=graph-rest-beta) en [driveItem](/graph/api/resources/driveitem?view=graph-rest-beta)|
| Adición        | Beta        | Se ha agregado el tipo complejo [storagePlanInformation](/graph/api/resources/storageplaninformation?view=graph-rest-beta) |
| Adición        | Beta        | Se agregó la propiedad **storagePlanInformation** para el tipo complejo de [cuota](/graph/api/resources/quota?view=graph-rest-beta) |
| Adición        | Beta        | Se agregó la **siguiente** propiedad de navegación para la entidad [unidad](/graph/api/resources/drive?view=graph-rest-beta) |
| Adición        | Beta        | Se agregó la acción [siga](/graph/api/driveitem-follow?view=graph-rest-beta) en [driveItem](/graph/api/resources/driveitem?view=graph-rest-beta) |
| Adición        | Beta        | Se agregó el [dejar de seguir](/graph/api/driveitem-unfollow?view=graph-rest-beta) API |
| Adición        | Beta        | Se agregó la propiedad **hasPassword** a la entidad de [permiso](/graph/api/resources/permission?view=graph-rest-beta) |
| Adición        | Beta        | Se agregó la propiedad **preventsDownload** para el tipo complejo [sharingLink](/graph/api/resources/sharinglink?view=graph-rest-beta) |
| Adición        | Beta        | Agrega la propiedad de navegación de **permiso** a la entidad [sharedDriveItem](/graph/api/resources/shareddriveitem?view=graph-rest-beta) |
| Adición        | Beta        | Agrega la propiedad de **ubicación geográfica** a la entidad [columnDefinition](/graph/api/resources/columndefinition?view=graph-rest-beta) |
| Adición        | Beta        | Se ha agregado el tipo complejo [geolocationColumn](/graph/api/resources/geolocationcolumn?view=graph-rest-beta) |
| Adición        | Beta        | Agrega la propiedad de **análisis** para la entidad [driveItem](/graph/api/resources/driveitem?view=graph-rest-beta) |
| Adición        | Beta        | Agrega la propiedad de **análisis** para la entidad de [sitio](/graph/api/resources/site?view=graph-rest-beta) |
| Adición        | Beta        | Agrega la propiedad de **análisis** para la entidad [listItem](/graph/api/resources/listitem?view=graph-rest-beta) |
...
| Adición        | Beta        | Se agregó la función **getActivitiesByInterval** en la entidad de [sitio](/graph/api/resources/site?view=graph-rest-beta) |
...
| Adición        | Beta        | Se ha agregado el tipo complejo [itemActionStat](/graph/api/resources/itemactionstat?view=graph-rest-beta) |
| Adición        | Beta        | Se ha agregado el tipo complejo [accessAction](/graph/api/resources/accessaction?view=graph-rest-beta) |
| Adición        | Beta        | Se ha agregado el tipo complejo [incompleteData](/graph/api/resources/incompletedata?view=graph-rest-beta) |
| Adición        | Beta        | Agrega la propiedad de **acceso** para el tipo complejo [itemActivity](/graph/api/resources/itemactivity?view=graph-rest-beta) |
...
| Adición        | v1.0        | Se agregó la acción de **vista previa** en la entidad [driveItem](/graph/api/resources/driveitem?view=graph-rest-1.0) |
| Adición        | v1.0        | Se ha agregado el tipo complejo [itemPreviewInfo](/graph/api/resources/itempreviewinfo?view=graph-rest-1.0) |
...
| Adición | v1.0 | Se ha agregado [onPremisesProvisioningErrors](/graph/api/resources/onpremisesprovisioningerror?view=graph-rest-1.0) (propiedad) a las entidades de [usuario](/graph/api/resources/user?view=graph-rest-1.0) y de [grupo](/graph/api/resources/group?view=graph-rest-1.0) que representa los errores de sincronización de Active directory al sincronizar directorios locales para Azure Active Directory cuando se usa Microsoft producto de sincronización (incluidos Azure Connect de AD, sincronización de directorios y MIM + conector).|
| Adición | v1.0 | [OnPremisesExtensionAttributes](/graph/api/resources/onpremisesextensionattributes?view=graph-rest-1.0) (propiedad) se agregan a la entidad de [usuario](/graph/api/resources/user?view=graph-rest-1.0) que contiene las propiedades de atributo de extensión personalizada quince. Para un usuario onPremisesSyncEnabled, este conjunto de propiedades se han usado en Active Directory local y sincronizado con Azure AD y es de sólo lectura. Para un usuario solo en la nube (donde onPremisesSyncEnabled es false), estas propiedades se pueden establecer durante la creación o actualizar.|
|Adición|v1.0|Agrega las propiedades **onPremisesDomainName**, **onPremisesSamAccountName**y **onPremisesUserPrincipalName** a la entidad de [usuario](/graph/api/resources/user?view=graph-rest-1.0)|
...
|Adición|v1.0|Se agregó al miembro **no asignado** al tipo enum [complianceStatus](/graph/api/resources/intune-shared-compliancestatus?view=graph-rest-1.0)|
|Adición|v1.0|Se agregó al miembro **pushNotification** para el tipo de enumeración [deviceComplianceActionType](/graph/api/resources/intune-deviceconfig-devicecomplianceactiontype?view=graph-rest-1.0)|
|Adición|v1.0|Se agregó al miembro **userAbandonment** para el tipo de enumeración [deviceEnrollmentFailureReason](/graph/api/resources/intune-troubleshooting-deviceenrollmentfailurereason?view=graph-rest-1.0)|
|Adición|v1.0|Agregado a los miembros **en peligro** y **mal configurado** para el tipo de enumeración [managedDevicePartnerReportedHealthState](/graph/api/resources/intune-devices-manageddevicepartnerreportedhealthstate?view=graph-rest-1.0)|
|Adición|v1.0|Se agregó al miembro **assignedToExternalMDM** para el tipo de enumeración [vppTokenState](/graph/api/resources/intune-onboarding-vpptokenstate?view=graph-rest-1.0)|
||
...
|Adición|beta|Se agregó la acción **importAppleDeviceIdentityList** en colección [importedAppleDeviceIdentity](/graph/api/resources/intune-enrollment-importedappledeviceidentity?view=graph-rest-beta) |
...
|Adición|beta|Se agregó la función [autopilotDeviceStream](/graph/api/intune-enrollment-importedwindowsautopilotdeviceidentityupload-autopilotdevicestream?view=graph-rest-beta) en [importedWindowsAutopilotDeviceIdentityUpload](/graph/api/resources/intune-enrollment-importedwindowsautopilotdeviceidentityupload?view=graph-rest-beta) |
|Eliminación|beta|Quita de la colección **uploadDepToken** |
|Eliminación|beta|Quita la acción **syncWithAppleDeviceEnrollmentProgram** en colección [depOnboardingSetting](/graph/api/resources/intune-enrollment-deponboardingsetting?view=graph-rest-beta) |
|Eliminación|beta|Quita la función **getEncryptionPublicKey** en colección [depOnboardingSetting](/graph/api/resources/intune-enrollment-deponboardingsetting?view=graph-rest-beta) |
...
|Adición|beta|Agrega las propiedades **vpnAlwaysOnPackageIdentifier** y **vpnEnableAlwaysOnLockdownMode** a la entidad [androidForWorkGeneralDeviceConfiguration](/graph/api/resources/intune-deviceconfig-androidforworkgeneraldeviceconfiguration?view=graph-rest-beta)|
|Eliminación|beta|Quita la propiedad **packageName** de la entidad [androidForWorkMobileAppConfiguration](/graph/api/resources/intune-apps-androidforworkmobileappconfiguration?view=graph-rest-beta)|
...
|Adición|beta|Agrega las propiedades **vpnAlwaysOnPackageIdentifier** y **vpnEnableAlwaysOnLockdownMode** a la entidad [androidWorkProfileGeneralDeviceConfiguration](/graph/api/resources/intune-deviceconfig-androidworkprofilegeneraldeviceconfiguration?view=graph-rest-beta)|
...
|Adición|beta|Agrega las propiedades **TokenType en**, **tokenName**, **syncedDeviceCount**, **defaultProfileDisplayName** y **dataSharingConsentGranted** a la entidad [depOnboardingSetting](/graph/api/resources/intune-enrollment-deponboardingsetting?view=graph-rest-beta)|
...
|Adición|beta|Agrega las propiedades **roleScopeTagIds** y **supportsScopeTags** a la entidad [deviceConfiguration](/graph/api/resources/intune-deviceconfig-deviceconfiguration?view=graph-rest-beta)|
...
|Cambio|beta|Cambiar las siguientes propiedades de la entidad [iosCertificateProfileBase](/graph/api/resources/intune-deviceconfig-ioscertificateprofilebase?view=graph-rest-beta) :<br/>**subjectAlternativeNameType** ha pasado de obligatoria a opcional.<br/>|
...
|Adición|beta|Agrega las propiedades **certificateStore** y **customSubjectAlternativeNames** a la entidad [iosScepCertificateProfile](/graph/api/resources/intune-deviceconfig-iosscepcertificateprofile?view=graph-rest-beta)|
...
|Adición|beta|Agrega las propiedades de **tipo de proveedor**, **userDomain**, **strictEnforcement**, **cloudName** y **excludeList** a la entidad [iosVpnConfiguration](/graph/api/resources/intune-deviceconfig-iosvpnconfiguration?view=graph-rest-beta)|
|Adición|beta|Se agregó la **safariBlockAutofill**, **cameraBlocked**, **iTunesBlockMusicService**, **spotlightBlockInternetResults**, **keyboardBlockDictation**, **definitionLookupBlocked**, ** appleWatchBlockAutoUnlock**, **iTunesBlockFileSharing**, **iCloudBlockDocumentSync**, **iCloudBlockMail**, **iCloudBlockAddressBook**, **iCloudBlockCalendar**, **iCloudBlockReminders**, ** iCloudBlockBookmarks**, **iCloudBlockNotes**, **airDropBlocked**, **passwordBlockModification** y **passwordBlockFingerprintUnlock** propiedades a la entidad [macOSGeneralDeviceConfiguration](/graph/api/resources/intune-deviceconfig-macosgeneraldeviceconfiguration?view=graph-rest-beta)|
|Adición|beta|Agrega las propiedades **roleScopeTagIds**, **windowsActiveMalwareCount**, **windowsRemediatedMalwareCount**, **notas** y **configurationManagerClientHealthState** a la entidad [managedDevice](/graph/api/resources/intune-devices-manageddevice?view=graph-rest-beta)|
...
|Adición|beta|Agrega las propiedades **targetVersion** y **updateVersion** a la entidad [officeSuiteApp](/graph/api/resources/intune-apps-officesuiteapp?view=graph-rest-beta)|
|Adición|beta|Agrega la propiedad de **recurso** a la entidad [resourceOperation](/graph/api/resources/intune-rbac-resourceoperation?view=graph-rest-beta)|
|Adición|beta|Agrega las propiedades **localStorage**, **setPowerPolicies** y **signInOnResume** a la entidad [sharedPCConfiguration](/graph/api/resources/intune-deviceconfig-sharedpcconfiguration?view=graph-rest-beta)|
...
|Adición|beta|Se agregó la **userRightsAccessCredentialManagerAsTrustedCaller**, **userRightsAllowAccessFromNetwork**, **userRightsBlockAccessFromNetwork**, **userRightsActAsPartOfTheOperatingSystem**, **userRightsLocalLogOn **, **userRightsBackupData**, **userRightsChangeSystemTime**, **userRightsCreateGlobalObjects**, **userRightsCreatePageFile**, **userRightsCreatePermanentSharedObjects**, ** userRightsCreateSymbolicLinks**, **userRightsCreateToken**, **userRightsDebugPrograms**, **userRightsRemoteDesktopServicesLogOn**, **userRightsDelegation**, **userRightsGenerateSecurityAudits **, **userRightsImpersonateClient**, **userRightsIncreaseSchedulingPriority**, **userRightsLoadUnloadDrivers**, **userRightsLockMemory**, **userRightsManageAuditingAndSecurityLogs**, ** userRightsManageVolumes**, **userRightsModifyFirmwareEnvironment**, **userRightsModifyObjectLabels**, **userRightsProfileSingleProcess**, **userRightsRemoteShutdown**, **userRightsRestoreData **, **userRightsTakeOwnership**, **userRightsRegisterProcessAsService**, **localSecurityOptionsMinimumSessionSecurityForNtlmSspBasedClients**, ** localSecurityOptionsMinimumSessionSecurityForNtlmSspBasedServers**, las propiedades **lanManagerAuthenticationLevel** y **lanManagerWorkstationEnableInsecureGuestLogons** a la [ windows10EndpointProtectionConfiguration](/graph/api/resources/intune-deviceconfig-windows10endpointprotectionconfiguration?view=graph-rest-beta) entidad|
|Adición|beta|Agrega las propiedades **passwordMinimumAgeInDays**, **tenantLockdownRequireNetworkDuringOutOfBoxExperience** y **dataProtectionBlockDirectMemoryAccess** a la entidad [windows10GeneralConfiguration](/graph/api/resources/intune-deviceconfig-windows10generalconfiguration?view=graph-rest-beta)|
...
|Adición|beta|Agrega las propiedades **enableDnsRegistration** y **dnsSuffixes** a la entidad [windows10VpnConfiguration](/graph/api/resources/intune-deviceconfig-windows10vpnconfiguration?view=graph-rest-beta)|
...
|Adición|beta|Agrega las propiedades **extractHardwareHash** y **deviceNameTemplate** a la entidad [windowsAutopilotDeploymentProfile](/graph/api/resources/intune-enrollment-windowsautopilotdeploymentprofile?view=graph-rest-beta)|
|Adición|beta|Agrega las propiedades **addressableUserName** y **userPrincipalName** a la entidad [windowsAutopilotDeviceIdentity](/graph/api/resources/intune-enrollment-windowsautopilotdeviceidentity?view=graph-rest-beta)|
...
|Adición|beta|Se agregó la **qualityUpdatesPauseStartDateTime**, **featureUpdatesPauseStartDateTime**, **featureUpdatesRollbackWindowInDays**, **qualityUpdatesWillBeRolledBack**, **featureUpdatesWillBeRolledBack**, ** qualityUpdatesRollbackStartDateTime** y las propiedades de **featureUpdatesRollbackStartDateTime** a la entidad [windowsUpdateForBusinessConfiguration](/graph/api/resources/intune-deviceconfig-windowsupdateforbusinessconfiguration?view=graph-rest-beta)|
...
|Adición|beta|Agrega las propiedades de navegación **defaultIosEnrollmentProfile**, **defaultMacOsEnrollmentProfile**, **enrollmentProfiles** y **importedAppleDeviceIdentities** a la entidad [depOnboardingSetting](/graph/api/resources/intune-enrollment-deponboardingsetting?view=graph-rest-beta)|
|Adición|beta|Agrega la propiedad de navegación **roleScopeTags** a la entidad [deviceAndAppManagementRoleAssignment](/graph/api/resources/intune-rbac-deviceandappmanagementroleassignment?view=graph-rest-beta)|
|Adición|beta|Agrega las propiedades de navegación **advancedThreatProtectionOnboardingStateSummary**, **roleScopeTags** y **importedWindowsAutopilotDeviceIdentityUploads** a la entidad [deviceManagement](/graph/api/resources/intune-androidforwork-devicemanagement?view=graph-rest-beta)|
|Adición|beta|Se agregó la propiedad **supportedDeviceTypes** para el tipo complejo [mobileAppIntentAndStateDetail](/graph/api/resources/intune-troubleshooting-mobileappintentandstatedetail?view=graph-rest-beta)|
|Adición|beta|Se agregó la propiedad **hideEscapeLink** para el tipo complejo [outOfBoxExperienceSettings](/graph/api/resources/intune-enrollment-outofboxexperiencesettings?view=graph-rest-beta)|
|Adición|beta|Agrega a los miembros **zscalerPrivateAccess**, **f5Access2018**, **citrixSso** y **paloAltoGlobalProtectV2** para el tipo de enumeración [appleVpnConnectionType](/graph/api/resources/intune-deviceconfig-applevpnconnectiontype?view=graph-rest-beta)|
|Adición|beta|Se agregó al miembro **userAbandonment** para el tipo de enumeración [deviceEnrollmentFailureReason](/graph/api/resources/intune-troubleshooting-deviceenrollmentfailurereason?view=graph-rest-beta)|
|Adición|beta|Se agregó al miembro **bloqueados** para el tipo de enumeración [enrollmentState](/graph/api/resources/intune-enrollment-enrollmentstate?view=graph-rest-beta)|
|Adición|beta|Se agregó al miembro **microsoft365ManagedMdm** para el tipo de enumeración [managementAgentType](/graph/api/resources/intune-devices-managementagenttype?view=graph-rest-beta)|
|Adición|beta|Se agregó al miembro **domainNameService** para el tipo de enumeración [subjectAlternativeNameType](/graph/api/resources/intune-deviceconfig-subjectalternativenametype?view=graph-rest-beta)|
|Adición|beta|Agrega a los miembros **wpa2Personal** y **wpa2Enterprise** para el tipo de enumeración [wiFiSecurityType](/graph/api/resources/intune-deviceconfig-wifisecuritytype?view=graph-rest-beta)|
|Adición|beta|Agrega a los miembros **enterpriseUnwantedSoftware**, **rescate** y **hipsRule** para el tipo de enumeración [windowsMalwareCategory](/graph/api/resources/intune-devices-windowsmalwarecategory?view=graph-rest-beta)|

### <a name="outlook-calendar"></a>Calendario de Outlook

| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Adición | Beta | Se agregó la [getSchedule](/graph/api/calendar-getschedule?view=graph-rest-beta) acción y el [freeBusyError](/graph/api/resources/freebusyerror?view=graph-rest-beta), [scheduleInformation](/graph/api/resources/scheduleinformation?view=graph-rest-beta)y [scheduleItem](/graph/api/resources/scheduleitem?view=graph-rest-beta) tipos complejos para admitir [Introducción a la disponibilidad, la información de disponibilidad para los usuarios, las listas de distribución y recursos para un determinado período de tiempo](outlook-get-free-busy-schedule.md). |

### <a name="outlook-mail"></a>Correo de Outlook

| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Adición        | v1.0        | Se ha agregado compatibilidad con la acción [getMailTips](/graph/api/user-getmailtips?view=graph-rest-1.0) obtener las sugerencias de correo electrónico para destinatarios concretos. Agrega los siguientes recursos: [automaticRepliesMailTips](/graph/api/resources/automaticrepliesmailtips?view=graph-rest-1.0), [sugerencias de correo electrónico](/graph/api/resources/mailtips?view=graph-rest-1.0), [mailTipsError](/graph/api/resources/mailtipserror?view=graph-rest-1.0). |

### <a name="reports-apis"></a>API de informes
| Tipo de cambio | Versión | Descripción                              |
|:------------|:--------|:-----------------------------------------|
| Adición    | v1.0    | Se agregó la propiedad **Activado en equipo compartidos** a [getoffice365activationsuserdetail](/graph/api/reportroot-getoffice365activationsuserdetail?view=graph-rest-1.0). |
| Adición    | v1.0    | Agrega la propiedad de **Activación de equipo compartidos** a [getoffice365activationsusercounts](/graph/api/reportroot-getoffice365activationsusercounts?view=graph-rest-1.0). |

### <a name="security-apis"></a>API de seguridad

| **Tipo de cambio** | **Versión** | **Descripción**              |
| :-------------- | :---------- | :--------------------------------------- |
| Adición        | beta       | Se ha agregado **activityGroupName**, **cloudAppStates**, **confianza**y propiedades **registryKeyStates** a [alerta](/graph/api/resources/alert?view=graph-rest-beta ). |
|Eliminación|beta| Se ha quitado **activityGroupStates**, **applicationStates**, **malwareWasRunning**, **riskScore** y **tipo de** las propiedades de [alerta](/graph/api/resources/alert?view=graph-rest-beta ). |
|Cambio|beta| Cambia el tipo de **comentarios** de un `String` a una `String collection`y cambiar el tipo de **gravedad** de un `String` a una enumeración [alertSeverity](/graph/api/resources/alertseverityenumtype?view=graph-rest-beta) en [alerta](/graph/api/resources/alert?view=graph-rest-beta). |
| Adición        | beta       | Agrega los siguientes tipos de recursos: <br/> [cloudAppSecurityState](/graph/api/resources/cloudappsecuritystate?view=graph-rest-beta) <br/> [fileHash](/graph/api/resources/filehash?view=graph-rest-beta) <br/> [registryKeyState](/graph/api/resources/registrykeystate?view=graph-rest-beta) |
|Eliminación|beta| Quita los siguientes tipos de recursos: <br/> **activityGroupState**  <br/> **applicationSecurityState** |
| Adición        | beta       | Agregado las enumeraciones siguientes: <br/> [alertSeverity](/graph/api/resources/alertseverityenumtype?view=graph-rest-beta) <br/> [connectionDirection](/graph/api/resources/connectiondirectionenumtype?view=graph-rest-beta) <br/> [connectionStatus](/graph/api/resources/connectionstatusenumtype?view=graph-rest-beta) <br/> [emailRole](/graph/api/resources/emailroleenumtype?view=graph-rest-beta) <br/> [fileHashType](/graph/api/resources/filehashtypeenumtype?view=graph-rest-beta) <br/> [registryHive](/graph/api/resources/registryhiveenumtype?view=graph-rest-beta)  <br/> [registryOperation](/graph/api/resources/registryoperationenumtype?view=graph-rest-beta) <br/> [registryValueType](/graph/api/resources/registryvaluetypeenumtype?view=graph-rest-beta)|
|Eliminación|beta| Se quitaron los siguientes tipos de enumeración: <br/> **alertType** <br/> **applicationPermissionsRequired** |
| Adición        | beta       | Propiedad se agregó **fileHash** a [fileSecurityState](/graph/api/resources/filesecuritystate?view=graph-rest-beta ).|
|Eliminación|beta| Se ha quitado **authenticodeHash256** y **sha256** las propiedades de [fileSecurityState](/graph/api/resources/filesecuritystate?view=graph-rest-beta). |
| Adición | beta | Se ha agregado un **sistema operativo** (propiedad) a [hostSecurityState](/graph/api/resources/hostsecuritystate?view=graph-rest-beta).|
| Adición | beta | Propiedades de **categoría**, **familiares**y **wasRunning** se ha agregado a [malwareState](/graph/api/resources/malwarestate?view=graph-rest-beta).|
|Eliminación|beta| Se han quitado **los alias de** propiedad [malwareState](/graph/api/resources/malwarestate?view=graph-rest-beta). |
|Cambio|beta| Mueve la propiedad **malwareWasRunning** de [alerta](/graph/api/resources/alert?view=graph-rest-beta ) a [malwareState](/graph/api/resources/malwarestate?view=graph-rest-beta) y nombre se ha cambiado a **wasRunning**. |
| Adición        | beta       | Se ha agregado un **applicationName**, **destinationDomain**, **dirección**, **domainRegisteredDateTime**, **localDnsName**, **natDestinationAddress**, **natDestinationPort**, **natSourceAddress**, ** natSourcePort**, **riskScore**, **estado**y **urlParameters** propiedades para [networkConnection](/graph/api/resources/networkconnection?view=graph-rest-beta ).|
|Cambio|beta| Propiedad **uri** se ha cambiado a **destinationUrl** en [networkConnection](/graph/api/resources/networkconnection?view=graph-rest-beta ). |
| Adición        | beta       | **FileHash** (propiedad) se agrega al [proceso](/graph/api/resources/process?view=graph-rest-beta ).|
|Eliminación|beta| Se ha quitado **authenticodeHash256** y **sha256** las propiedades de [proceso](/graph/api/resources/process?view=graph-rest-beta ). |
| Adición        | beta       | Se ha agregado **aadUserId**, **emailRole**, **isVpn**y las propiedades de **logonIp** a [userSecurityState](/graph/api/resources/usersecuritystate?view=graph-rest-beta).|
|Cambio|beta| **LogonIpAddress** (propiedad) se ha cambiado a **logonIp** en [userSecurityState](/graph/api/resources/usersecuritystate?view=graph-rest-beta). |
| Adición        | beta       | Agregar propiedad **wasRunning** a [vulnerabilityState](/graph/api/resources/vulnerabilitystate?view=graph-rest-beta).|
|Eliminación|beta| Se ha quitado el **nombre de la** propiedad [vulnerabilityState](/graph/api/resources/vulnerabilitystate?view=graph-rest-beta). |
...
| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
|Cambio|beta|Recurso actualizado [chatmessage](/graph/api/resources/chatmessage?view=graph-rest-beta)|
...
| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Adición | Beta | Se ha agregado un **progreso** (propiedad) a [sychronizationStatus](/graph/api/resources/synchronization-synchronizationstatus?view=graph-rest-beta) para permitir que los clientes para supervisar el progreso de un trabajo de sincronización.|
...
### <a name="identity-and-access-apis"></a>Identidad y API de acceso a

| **Tipo de cambio** | **Versión**   | **Descripción**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Adición | beta | Se ha agregado la característica [access revisa](/graph/api/resources/accessreviews-root?view=graph-rest-beta) a [Azure AD](/graph/api/resources/azure-ad-overview?view=graph-rest-beta). |
...
| Adición | v1.0 | Se ha agregado **ageGroup**, **legalAgeGroupClassification**y **ConsentRequiredForMinor** propiedades para recursos de [usuario](/graph/api/resources/user?view=graph-rest-1.0)
...
|Eliminación|beta|Quita la función exportMobileConfig](/graph/api/intune_corpenrollment_enrollmentprofile_exportmobileconfig?view=graph-rest-beta) en [enrollmentProfile](/graph/api/resources/intune-corpenrollment-enrollmentprofile?view=graph-rest-beta) |
...
| Adición        | v1.0        | Se agregaron las siguientes API para la directiva de ciclo de vida del grupo: [Crear](/graph/api/grouplifecyclepolicy-post-grouplifecyclepolicies?view=graph-rest-1.0), [Enumerar](/graph/api/grouplifecyclepolicy-list?view=graph-rest-1.0), [Obtener](/graph/api/grouplifecyclepolicy-get?view=graph-rest-1.0), [Actualizar](/graph/api/grouplifecyclepolicy-update?view=graph-rest-1.0), [Eliminar](/graph/api/grouplifecyclepolicy-delete?view=graph-rest-1.0), [Agregar grupo](/graph/api/grouplifecyclepolicy-addgroup?view=graph-rest-1.0), [Quitar grupo ](/graph/api/grouplifecyclepolicy-removegroup?view=graph-rest-1.0) |
...
| Adición        | Beta        | Se ha agregado compatibilidad con la acción [getMailTips](/graph/api/user-getmailtips?view=graph-rest-beta) obtener las sugerencias de correo electrónico para destinatarios concretos. Agrega los siguientes recursos: [automaticRepliesMailTips](/graph/api/resources/automaticrepliesmailtips?view=graph-rest-beta), [sugerencias de correo electrónico](/graph/api/resources/mailtips?view=graph-rest-beta), [mailTipsError](/graph/api/resources/mailtipserror?view=graph-rest-beta). |
...
|**Tipo de cambio**|**Versión**|**Descripción**|
|:--------------|:-----------|:--------------|
|Cambio importante|Beta|Cambios realizados en la API de findMeetingTimes. Para obtener más información, vea la entrada de la [API de Microsoft Graph findMeetingTimes actualizar](https://dev.office.com/microsoft-graph-findmeetingtimes-api-update) de blog. Este cambio entra en vigor el 19 de mayo de 2016.

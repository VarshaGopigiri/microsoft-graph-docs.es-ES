...
Este registro de cambios abarca las modificaciones en Microsoft Graph, incluidas las API de Microsoft Graph del punto de conexión beta y v1.0.  
...
|**Tipo de cambio**|**Versión**|**Descripción**|
|:--------------|:----------|:--------------|
| Adición | v1.0 y beta | Se agregaron las propiedades de navegación **drives** y **sites** a **group**.

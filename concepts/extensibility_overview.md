...
Puede utilizar las extensiones de todos estos recursos al iniciar sesión con una cuenta profesional o educativa. Además, puede utilizar las extensiones en estos recursos: **event** (evento), **post** (publicación), **group** (grupo), **message** (mensaje), **contact** (contacto) y **user** (usuario), cuando inicie sesión con una cuenta personal. 
...
Puesto que las extensiones de esquema son accesibles como tipos complejos en las instancias de los recursos de destino, puede realizar operaciones CRUD en los datos personalizados en una extensión de esquema de las siguientes maneras:

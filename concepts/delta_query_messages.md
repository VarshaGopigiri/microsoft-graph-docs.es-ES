...
- [Consulta delta de Microsoft Graph](delta_query_overview.md)
- [Obtener los cambios incrementales de los eventos en una vista de calendario](delta_query_events.md)

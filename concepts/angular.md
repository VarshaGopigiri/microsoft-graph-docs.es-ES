...
5. **Si utiliza el SDK de Microsoft Graph**, instale y referencie el SDK.  
   a. En el símbolo del sistema, use el siguiente comando para instalar el SDK.
        
        bower install https://github.com/microsoftgraph/msgraph-sdk-javascript.git
         
   b. En el archivo **public/index.html**, agregue el código siguiente en el elemento **head** sobre la sección `<!-- App code. -->`:
...
4. **Si utiliza el SDK de Microsoft Graph**, abra app.js y agregue el código siguiente al final del archivo. Esto inicializa el SDK.
...
Si usa el SDK de Microsoft Graph, siga leyendo. Si usa REST, consulte la sección [Usar la API de REST](#using-the-rest-api).

### <a name="using-the-sdk"></a>Usar el SDK
...
6. Guarde todos los cambios. Ahora, ya puede [ejecutar la aplicación](#run-the-app).

...
Los ejemplos de inicio rápido basados en la tecnología web proporcionan la lógica necesaria para iniciar y hospedar un servidor web local. Por ejemplo, el ejemplo PHP basado en el tiempo de ejecución de PHP 5.4.0+ incluye un [servidor web integrado](https://php.net/manual/en/features.commandline.webserver.php) que usará para el desarrollo. No está pensado para usarse en un entorno de producción. 

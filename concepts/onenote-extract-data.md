...
Para extraer y transformar datos, solo tiene que incluir un div que especifique el contenido de origen, el método de extracción y el comportamiento de reserva en la solicitud [create-page](onenote-create-page.md) o [update-page](onenote-update-page.md). La API representa los datos extraídos de la página en un formato de fácil lectura. 
...
Para extracciones de tarjetas de presentación, la imagen se envía como un elemento con nombre en una solicitud de varias partes. Vea [Agregar imágenes y archivos](onenote-images-files.md) para obtener ejemplos de cómo enviar una imagen en una solicitud.

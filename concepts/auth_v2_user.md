...
## <a name="2-get-authorization"></a>2. Obtener autorización
...
- API web back-end: por ejemplo, en escenarios en los que una aplicación cliente, como una aplicación nativa, implementa una funcionalidad en el back-end de una API web. Con el punto de conexión de Azure AD v2.0, la aplicación cliente y la API web back-end deben tener el mismo identificador de aplicación. 

Para obtener más información sobre los tipos de aplicaciones compatibles con el punto de conexión de Azure AD v2.0, vea [Tipos de aplicación](https://docs.microsoft.com/azure/active-directory/develop/active-directory-v2-flows).
...
- La aplicación requerirá un identificador de aplicación diferente (Id. de cliente) para cada plataforma.

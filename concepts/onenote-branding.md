...
---
# <a name="branding-guidelines-for-onenote-api-developers"></a>Instrucciones de personalización de marca para desarrolladores de API de OneNote 
...
Si tiene preguntas sobre estas instrucciones o quiere crear comunicaciones nuevas con los recursos de marca que se muestran aquí, comuníquese con nosotros en [@onenotedev](https://twitter.com/onenotedev).

...
En los ejemplos siguientes, se muestra cómo actualizar las propiedades de [RangeFormat](../api-reference/v1.0/resources/rangeformat.md), [RangeFill](../api-reference/v1.0/resources/rangefill.md) y [RangeFont](../api-reference/v1.0/resources/rangefont.md) de un rango especificado.

...
Se necesitan las propiedades `changeType`, `notificationUrl`, `resource` y `expirationDateTime`. Vea las definiciones y los valores de las propiedades en [Tipo de recurso de suscripción](../api-reference/v1.0/resources/subscription.md).
...
Si se ejecuta correctamente, Microsoft Graph muestra un código `200 OK` y un objeto [subscription](../api-reference/v1.0/resources/subscription.md) en el cuerpo. El objeto "suscription" incluye el nuevo valor de `expirationDateTime`.
...
| subscriptionExpirationDateTime | [dateTime](http://tools.ietf.org/html/rfc3339) | Fecha de expiración de la suscripción. |

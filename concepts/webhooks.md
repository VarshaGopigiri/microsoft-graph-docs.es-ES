...
O a un ID específico: `users/{id}`, `groups/{id}`, `groups/{id}/conversations`
...
Se necesitan las propiedades `changeType`, `notificationUrl`, `resource` y `expirationDateTime`. Vea las definiciones y los valores de las propiedades en [Tipo de recurso de suscripción](../api-reference/v1.0/resources/subscription.md). Aunque no se necesita la propiedad `clientState`, tiene que incluirla para cumplir nuestro proceso de control de notificaciones recomendado.

Si se ejecuta correctamente, Microsoft Graph muestra un código `201 Created` y un objeto [subscription](../api-reference/v1.0/resources/subscription.md) en el cuerpo.
...
* Cuotas de suscripción permitidas:
  ...
  * Por aplicación: 50 000 suscripciones totales
  * Por espacio empresarial: 35 suscripciones totales en todas las aplicaciones
  * Por aplicación y espacio empresarial: 7 suscripciones totales

* No se admiten los espacios empresariales de Azure AD B2C

* No se admiten los usuarios de cuentas de consumidor
...
Si se ejecuta correctamente, Microsoft Graph devuelve un código `200 OK` y un objeto [subscription](../api-reference/v1.0/resources/subscription.md) en el cuerpo. El objeto de suscripción incluye el nuevo valor de expirationDateTime. 
...
* [Tipo de recurso de suscripción](../api-reference/v1.0/resources/subscription.md)
* [Obtener suscripción](../api-reference/v1.0/api/subscription_get.md)
* [Crear suscripción](../api-reference/v1.0/api/subscription_post_subscriptions.md)
* [Ejemplo de webhooks de Microsoft Graph para Node.js](https://github.com/OfficeDev/Microsoft-Graph-Nodejs-Webhooks)
* [Ejemplo de webhooks de Microsoft Graph para ASP.NET](https://github.com/OfficeDev/Microsoft-Graph-ASPNET-Webhooks)

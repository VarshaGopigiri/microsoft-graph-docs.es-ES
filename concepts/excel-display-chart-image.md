...
Al realizar una [operación GET para recuperar una imagen de gráfico](/api-reference/v1.0/api/chart_image.md), la API de Excel devuelve una imagen como una cadena Base 64.

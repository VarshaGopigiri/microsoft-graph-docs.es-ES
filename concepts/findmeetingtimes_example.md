...
Las dos llamadas a **findMeetingTimes** incluyen los siguientes parámetros. Todos los [parámetros](../api-reference/v1.0/api/user_findmeetingtimes.md#request-body) de **findMeetingTimes** son opcionales.

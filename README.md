...
* **Listas numeradas:** Para crear una lista numerada (ordenada), comience la línea con `1. `. Si quiere varios elementos dentro de un elemento de lista único, puede dar formato a la lista como sigue:
    ...
    1. Tenga en cuenta que esta línea cuenta con pestañas después de "."
...
* **Vínculos:** La sintaxis básica para un vínculo es `[visible link text](link url)`. Los vínculos también pueden tener referencias, como se describe en la sección **Referencias de vínculos e imágenes** más adelante.
* **Imágenes:** La sintaxis básica para una imagen es `![alt text for the image](image url)`. Las imágenes también pueden tener referencias, como se describe en la sección **Referencias de vínculos e imágenes** más adelante.
* **HTML en línea:** Markdown le permite incluir alineado HTML, pero debe evitarse.

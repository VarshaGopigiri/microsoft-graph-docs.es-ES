...
| :--------------------------------------- | :---------- | :--------------------------------------- |
| [Obtener detalles del usuario](../api/reportroot-getskypeforbusinessactivityuserdetail.md) | Secuencia      | Obtiene información sobre la actividad de Skype Empresarial por usuario. |
| [Obtener recuentos de actividad](../api/reportroot-getskypeforbusinessactivitycounts.md) | Secuencia      | Obtiene las tendencias sobre el número de usuarios que organizaron y participaron en sesiones de conferencia realizadas en la organización con Skype Empresarial. En el informe, también se incluye el número de sesiones de punto a punto. |
| [Obtener número de usuarios](../api/reportroot-getskypeforbusinessactivityusercounts.md) | Secuencia      | Obtiene las tendencias sobre el número de usuarios únicos que organizaron y participaron en sesiones de conferencia realizadas en la organización con Skype Empresarial. En el informe, también se incluye el número de sesiones de punto a punto. |

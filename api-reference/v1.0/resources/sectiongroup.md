...
|sections|Colección [OnenoteSection](section.md)|Secciones del grupo de secciones. Solo lectura. Admite valores NULL.|
...
|[Create section](../api/sectiongroup_post_sections.md) |[OnenoteSection](section.md)| Crear una sección publicándola en el grupo de secciones especificado de la colección de secciones.|
|[List sections](../api/sectiongroup_list_sections.md) |Colección [OnenoteSection](section.md)| Obtener una colección de secciones en el grupo de secciones especificado.|

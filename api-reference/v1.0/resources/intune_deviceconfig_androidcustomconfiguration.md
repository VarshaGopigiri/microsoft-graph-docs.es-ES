...
|:---|:---|:---|
|[Enumerar androidCustomConfigurations](../api/intune_deviceconfig_androidcustomconfiguration_list.md)|Colección [androidCustomConfiguration](../resources/intune_deviceconfig_androidcustomconfiguration.md)|Enumere las propiedades y las relaciones de los objetos [androidCustomConfiguration](../resources/intune_deviceconfig_androidcustomconfiguration.md).|
|[Obtener androidCustomConfiguration](../api/intune_deviceconfig_androidcustomconfiguration_get.md)|[androidCustomConfiguration](../resources/intune_deviceconfig_androidcustomconfiguration.md)|Lea las propiedades y las relaciones del objeto [androidCustomConfiguration](../resources/intune_deviceconfig_androidcustomconfiguration.md).|
|[Crear androidCustomConfiguration](../api/intune_deviceconfig_androidcustomconfiguration_create.md)|[androidCustomConfiguration](../resources/intune_deviceconfig_androidcustomconfiguration.md)|Cree un objeto [androidCustomConfiguration](../resources/intune_deviceconfig_androidcustomconfiguration.md).|
|[Eliminar androidCustomConfiguration](../api/intune_deviceconfig_androidcustomconfiguration_delete.md)|Ninguna|Elimina un [androidCustomConfiguration](../resources/intune_deviceconfig_androidcustomconfiguration.md).|
|[Actualizar androidCustomConfiguration](../api/intune_deviceconfig_androidcustomconfiguration_update.md)|[androidCustomConfiguration](../resources/intune_deviceconfig_androidcustomconfiguration.md)|Actualice las propiedades de un objeto [androidCustomConfiguration](../resources/intune_deviceconfig_androidcustomconfiguration.md).|

...
Esta clase contiene la configuración de cumplimiento para el perfil de trabajo de Android.
...
|:---|:---|:---|
|[Enumerar androidWorkProfileCompliancePolicies](../api/intune_deviceconfig_androidworkprofilecompliancepolicy_list.md)|Colección [androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md)|Enumerar las propiedades y las relaciones de los objetos [androidWorkProfileCompliancePolicy](../resources/intune_deviceconfig_androidworkprofilecompliancepolicy.md).|

...
|appAvailability|[managedAppAvailability](../resources/intune_apps_managedappavailability.md)|La disponibilidad de la aplicación. Los valores posibles son: `global` y `lineOfBusiness`.|
|versión|String|La versión de la aplicación.|

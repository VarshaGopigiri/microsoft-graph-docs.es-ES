...
|:---|:---|:---|
|[Enumerar androidGeneralDeviceConfigurations](../api/intune_deviceconfig_androidgeneraldeviceconfiguration_list.md)|Colección [androidGeneralDeviceConfiguration](../resources/intune_deviceconfig_androidgeneraldeviceconfiguration.md)|Enumere las propiedades y las relaciones de los objetos [androidGeneralDeviceConfiguration](../resources/intune_deviceconfig_androidgeneraldeviceconfiguration.md).|
|[Obtener androidGeneralDeviceConfiguration](../api/intune_deviceconfig_androidgeneraldeviceconfiguration_get.md)|[androidGeneralDeviceConfiguration](../resources/intune_deviceconfig_androidgeneraldeviceconfiguration.md)|Lea las propiedades y las relaciones del objeto [androidGeneralDeviceConfiguration](../resources/intune_deviceconfig_androidgeneraldeviceconfiguration.md).|
|[Crear androidGeneralDeviceConfiguration](../api/intune_deviceconfig_androidgeneraldeviceconfiguration_create.md)|[androidGeneralDeviceConfiguration](../resources/intune_deviceconfig_androidgeneraldeviceconfiguration.md)|Cree un objeto [androidGeneralDeviceConfiguration](../resources/intune_deviceconfig_androidgeneraldeviceconfiguration.md).|
|[Eliminar androidGeneralDeviceConfiguration](../api/intune_deviceconfig_androidgeneraldeviceconfiguration_delete.md)|Ninguno|Elimina un [androidGeneralDeviceConfiguration](../resources/intune_deviceconfig_androidgeneraldeviceconfiguration.md).|
|[Actualizar androidGeneralDeviceConfiguration](../api/intune_deviceconfig_androidgeneraldeviceconfiguration_update.md)|[androidGeneralDeviceConfiguration](../resources/intune_deviceconfig_androidgeneraldeviceconfiguration.md)|Actualice las propiedades de un objeto [androidGeneralDeviceConfiguration](../resources/intune_deviceconfig_androidgeneraldeviceconfiguration.md).|
...
|appsBlockClipboardSharing|Booleano|Indica si se va a impedir el uso compartido del Portapapeles para copiar y pegar entre aplicaciones.|
...
|cameraBlocked|Booleano|Indica si se va a impedir usar la cámara.|
|cellularBlockDataRoaming|Booleano|Indica si se va a bloquear la itinerancia de datos.|
|cellularBlockMessaging|Booleano|Indica si se va a impedir la mensajería SMS/MMS.|
...
|compliantAppListType|Cadena|Tipo de lista que se encuentra en la CompliantAppsList. Los valores posibles son: `none`, `appsInListCompliant` y `appsNotInListCompliant`.|
...
|googleAccountBlockAutoSync|Booleano|Indica si se va a impedir la sincronización automática de cuentas de Google.|
|googlePlayStoreBlocked|Booleano|Indica si se va a bloquear la Google Play Store.|
...
|kioskModeApps|Colección [appListItem](../resources/intune_deviceconfig_applistitem.md)|Una lista de aplicaciones que se podrán ejecutar cuando el dispositivo esté en modo de pantalla completa. Esta colección puede contener un máximo de 500 elementos.|
...
|passwordBlockTrustAgents|Booleano|Indica si se va a bloquear Smart Lock y otros agentes de confianza.|
...
|passwordRequiredType|Cadena|Tipo de contraseña que es necesario. Los valores posibles son: `deviceDefault`, `alphabetic`, `alphanumeric`, `alphanumericWithSymbols`, `lowSecurityBiometric`, `numeric`, `numericComplex` y `any`.|
|passwordRequired|Booleano|Indica si se va a requerir una contraseña.|
|powerOffBlocked|Booleano|Indica si se va a impedir apagar el dispositivo.|
...
|storageBlockRemovableStorage|Booleano|Indica si se va a impedir el uso de almacenamiento extraíble.|
...
|voiceAssistantBlocked|Booleano|Indica si se va a impedir usar el asistente de voz.|
...
|webBrowserCookieSettings|Cadena|Configuración de cookies en el explorador web. Los valores posibles son: `browserDefault`, `blockAlways`, `allowCurrentWebSite`, `allowFromWebsitesVisited` y `allowAlways`.|

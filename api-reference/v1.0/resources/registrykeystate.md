...
|Key|String|Clave del registro (es decir, modificado) actual (que no sean SUBÁRBOL).|
|oldKey|String|Anterior (es decir, antes de cambiar) clave del registro (excluye SUBÁRBOL).|
|oldValueData|String|Anterior (es decir, antes de cambiar) los datos de valor de la clave del registro (contenido).|
|oldValueName|String|Anterior (es decir, antes de cambiar) nombre del valor de la clave del registro.|
...
|datosDeValor|String|Datos de valor de la clave de actuales del registro (es decir, modificado) (contenido).|
|Valor|String|Nombre del valor de la clave del registro (es decir, modificado) actual|

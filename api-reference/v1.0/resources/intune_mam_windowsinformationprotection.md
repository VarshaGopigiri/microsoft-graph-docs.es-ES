...
|enforcementLevel|Cadena|Nivel de obligatoriedad del trabajo en curso. Consulte la definición de enumeración para los valores compatibles. Los valores posibles son: `noProtection`, `encryptAndAuditOnly`, `encryptAuditAndPrompt` y `encryptAuditAndBlock`.|
...
|asignaciones|Colección targetedManagedAppPolicyAssignment|Propiedad de navegación a la lista de grupos de seguridad destinados a la directiva.|

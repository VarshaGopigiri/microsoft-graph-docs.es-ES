...
La configuración del usuario actual. Para obtener información sobre cómo obtener o actualizar la configuración de usuario, vea [obtener la configuración](../api/user_get_settings.md) y [actualización de la configuración](../api/user_update_settings.md).

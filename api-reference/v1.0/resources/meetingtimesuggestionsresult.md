...
|:---------------|:--------|:----------|
|emptySuggestionsReason|Cadena|Una razón para no devolver ninguna sugerencia de reunión. Los valores posibles son: `attendeesUnavailable`, `attendeesUnavailableOrUnknown`, `locationsUnavailable`, `organizerUnavailable` o `unknown`. Esta propiedad es una cadena vacía si la propiedad **meetingTimeSuggestions** incluye cualquier sugerencias de reunión.|
|meetingTimeSuggestions|Colleción [meetingTimeSuggestion](meetingTimeSuggestion.md)|Matriz de sugerencias de reunión.|

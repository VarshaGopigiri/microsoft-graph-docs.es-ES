...
|label|String| Valor que se usa al configurar el *alias/host/name* del registro CNAME en el host DNS. |
|recordType|String| Tipo de registro DNS. El valor es siempre *CName*. Clave|

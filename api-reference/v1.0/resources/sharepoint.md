...
El recurso del [sitio][] se asigna a `SPWeb`.
El recurso [site][] raíz (`SPWeb`) en una colección de sitios tiene una faceta [siteCollection](sitecollection.md), que contiene información sobre `SPSite`.

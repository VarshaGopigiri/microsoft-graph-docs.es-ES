...
|themeColor|[rgbColor](../resources/intune-onboarding-rgbcolor.md)|Color de tema principal utilizado en el portal web y las aplicaciones del Portal de empresa.|

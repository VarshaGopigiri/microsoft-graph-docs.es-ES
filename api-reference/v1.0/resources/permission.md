...
| shareId       | Cadena                                    | Token único que se puede utilizar para tener acceso a este elemento compartido a través de la [API **shares**](../api/shares-get.md). Solo lectura.
...
| [Agregar](../api/driveitem-invite.md)                        | `POST /drive/items/{item-id}/invite`

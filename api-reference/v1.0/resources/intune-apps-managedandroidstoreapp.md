...
|:---|:---|:---|
|[Enumerar managedAndroidStoreApps](../api/intune-apps-managedandroidstoreapp-list.md)|Colección [managedAndroidStoreApp](../resources/intune-apps-managedandroidstoreapp.md)|Enumere las propiedades y las relaciones de los objetos [managedAndroidStoreApp](../resources/intune-apps-managedandroidstoreapp.md).|
|[Obtener managedAndroidStoreApp](../api/intune-apps-managedandroidstoreapp-get.md)|[managedAndroidStoreApp](../resources/intune-apps-managedandroidstoreapp.md)|Lea las propiedades y las relaciones del objeto [managedAndroidStoreApp](../resources/intune-apps-managedandroidstoreapp.md).|
|[Crear managedAndroidStoreApp](../api/intune-apps-managedandroidstoreapp-create.md)|[managedAndroidStoreApp](../resources/intune-apps-managedandroidstoreapp.md)|Cree un objeto [managedAndroidStoreApp](../resources/intune-apps-managedandroidstoreapp.md).|
|[Eliminar managedAndroidStoreApp](../api/intune-apps-managedandroidstoreapp-delete.md)|Ninguna|Elimina un [managedAndroidStoreApp](../resources/intune-apps-managedandroidstoreapp.md).|
|[Actualizar managedAndroidStoreApp](../api/intune-apps-managedandroidstoreapp-update.md)|[managedAndroidStoreApp](../resources/intune-apps-managedandroidstoreapp.md)|Actualice las propiedades de un objeto [managedAndroidStoreApp](../resources/intune-apps-managedandroidstoreapp.md).|
...
|minimumSupportedOperatingSystem|[androidMinimumOperatingSystem](../resources/intune-apps-androidminimumoperatingsystem.md)|El valor para el sistema operativo mínimo compatible.|

...
Lea las propiedades y las relaciones del objeto [mobileLobApp](../resources/intune_apps_mobilelobapp.md).
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y un objeto [mobileLobApp](../resources/intune_apps_mobilelobapp.md) en el cuerpo de la respuesta.

...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y el objeto [WorkbookChartGridlines](../resources/chartgridlines.md) en el cuerpo de la respuesta.

...
---
# <a name="downloadapplepushnotificationcertificatesigningrequest-function"></a>Función downloadApplePushNotificationCertificateSigningRequest

> **Nota:** El uso de las API de Microsoft Graph para configurar las directivas y los controles de Intune requiere que el cliente tenga la [licencia correcta](https://go.microsoft.com/fwlink/?linkid=839381) para el servicio Intune.

Descargar solicitud de firma de certificado de notificación de inserción de Apple
...
Si se ejecuta correctamente, esta función devuelve un código de respuesta `200 OK` y un objeto String en el cuerpo de la respuesta.

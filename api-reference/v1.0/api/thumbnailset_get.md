<span data-ttu-id="8e9ff-p101">{token} de portador. Necesario.</span><span class="sxs-lookup"><span data-stu-id="8e9ff-p101">Bearer token. Required.</span></span>  | {token} de portador. Necesario. |

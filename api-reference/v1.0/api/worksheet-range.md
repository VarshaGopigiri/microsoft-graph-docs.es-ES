...
Obtiene el objeto de rango especificado por la dirección o el nombre.
...
Si el opcional `address` parámetro no se especifica, esta función devuelve el rango de hoja de cálculo completa.

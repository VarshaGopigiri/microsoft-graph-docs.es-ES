...
Cree un objeto [detectedApp](../resources/intune_devices_detectedapp.md).
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `201 Created` y un objeto [detectedApp](../resources/intune_devices_detectedapp.md) en el cuerpo de la respuesta.

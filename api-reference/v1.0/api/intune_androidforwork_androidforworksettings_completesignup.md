# <a name="completesignup-action"></a>Acción completeSignup

> **Nota:** El uso de las API de Microsoft Graph para configurar las directivas y los controles de Intune requiere que el cliente tenga la [licencia correcta](https://go.microsoft.com/fwlink/?linkid=839381) para el servicio Intune.

Completa el flujo de registro para la administración de Android for Work.
...
|:---|:---|:---|
|enterpriseToken|String|El token Enterprise anexado a la dirección URL de devolución de llamada después de completar correctamente el registro.|

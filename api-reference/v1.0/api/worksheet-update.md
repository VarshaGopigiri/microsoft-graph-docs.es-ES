...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y el objeto [WorkbookWorksheet](../resources/worksheet.md) actualizado en el cuerpo de la respuesta.

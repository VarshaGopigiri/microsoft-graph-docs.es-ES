...
---
# <a name="get-metadata-for-a-list"></a>Obtener los metadatos de una lista

Devuelve los metadatos de un recurso [list][].
...
Con las instrucciones `select` y `expand`, puede recuperar metadatos de listas, definiciones de columnas y elementos de lista en una sola solicitud.

...
|seriesBy|string|Opcional. Especifica las filas o columnas de forma que se usan como series de datos en el gráfico.  Los valores posibles son: `Auto`, `Columns`, `Rows`.|

...
Cree un objeto [termsAndConditions](../resources/intune_companyterms_termsandconditions.md).
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `201 Created` y un objeto [termsAndConditions](../resources/intune_companyterms_termsandconditions.md) en el cuerpo de la respuesta.

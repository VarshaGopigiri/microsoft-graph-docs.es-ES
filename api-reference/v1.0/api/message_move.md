# <a name="message-move"></a>mensaje: mover

Mueve un mensaje a una carpeta. Esto crea una nueva copia del mensaje en la carpeta de destino y elimina el mensaje original.
...
La siguiente solicitud mueve el mensaje especificado a la carpeta de Elementos eliminados, identificada por su bien conocido nombre de la carpeta `deleteditems`.
<!-- {
  "blockType": "request",

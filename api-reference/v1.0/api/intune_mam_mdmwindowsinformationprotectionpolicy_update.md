...
|isAssigned|Boolean|Indica si la directiva se implementará en los grupos de inclusión o no. Heredado de [windowsInformationProtection](../resources/intune_mam_windowsinformationprotection.md)|

...
Lea las propiedades y las relaciones del objeto [mobileAppContent](../resources/intune_apps_mobileappcontent.md).
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y el objeto de [mobileAppContent](../resources/intune_apps_mobileappcontent.md) en el cuerpo de la respuesta.

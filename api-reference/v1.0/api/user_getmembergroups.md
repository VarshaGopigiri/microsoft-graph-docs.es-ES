...
Se requiere uno de los siguientes **ámbitos** para ejecutar esta API: *User.Read* o *User.ReadBasic.All* and *Group.Read.All*; *Directory.Read.All; Directory.ReadWrite.All; Directory.AccessAsUser.All*

# <a name="user-getmembergroups"></a><span data-ttu-id="dfb32-101">usuario: getMemberGroups</span><span class="sxs-lookup"><span data-stu-id="dfb32-101">user: getMemberGroups</span></span>

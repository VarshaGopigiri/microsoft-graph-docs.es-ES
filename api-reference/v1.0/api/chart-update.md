...
Actualizar las propiedades del objeto chart.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y el objeto [WorkbookChart](../resources/chart.md) actualizado en el cuerpo de la respuesta.

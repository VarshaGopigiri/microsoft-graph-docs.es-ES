...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [WorkbookChartPoint](../resources/chartpoint.md) en el cuerpo de la respuesta.

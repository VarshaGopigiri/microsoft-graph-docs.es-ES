...
Restauración de un [equipo](../resources/team.md)de archivado. Esto restaura la capacidad de los usuarios enviar mensajes y editar el equipo, respetando por la configuración de inquilino y del equipo. Los equipos se archivan con el [archivo](team_archive.md) API.

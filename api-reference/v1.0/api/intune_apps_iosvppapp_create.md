...
Cree un objeto [iosVppApp](../resources/intune_apps_iosvppapp.md).
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `201 Created` y un objeto [iosVppApp](../resources/intune_apps_iosvppapp.md) en el cuerpo de la respuesta.

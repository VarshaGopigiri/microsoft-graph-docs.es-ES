...
Cree un objeto [auditEvent](../resources/intune_auditing_auditevent.md).
...
En la tabla siguiente se muestran las propiedades necesarias para crear el objeto auditEvent.
...
|categoría|String|Categoría de auditoría.|



## <a name="response"></a>Respuesta
Si se ejecuta correctamente, este método devuelve un código de respuesta `201 Created` y un objeto [auditEvent](../resources/intune_auditing_auditevent.md) en el cuerpo de la respuesta.

...
|:---------------|:--------|:----------|
|classifyAs|cadena| Especifica cómo se deben clasificar siempre los mensajes entrantes de un remitente determinado. Los valores posibles son: `focused`, `other`.|

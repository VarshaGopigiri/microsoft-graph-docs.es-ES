...
Recuperar las propiedades y relaciones del objeto tablecolumn.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y [WorkbookTableColumn](../resources/tablecolumn.md) objeto en el cuerpo de la respuesta.

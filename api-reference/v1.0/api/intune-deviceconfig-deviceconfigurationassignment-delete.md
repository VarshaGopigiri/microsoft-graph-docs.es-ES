...
ms.locfileid: "27029504"
---
# <a name="delete-deviceconfigurationassignment"></a><span data-ttu-id="16692-103">Eliminar deviceConfigurationAssignment</span><span class="sxs-lookup"><span data-stu-id="16692-103">Delete deviceConfigurationAssignment</span></span>
...
<span data-ttu-id="16692-105">Elimina un [deviceConfigurationAssignment](../resources/intune-deviceconfig-deviceconfigurationassignment.md).</span><span class="sxs-lookup"><span data-stu-id="16692-105">Deletes a [deviceConfigurationAssignment](../resources/intune-deviceconfig-deviceconfigurationassignment.md).</span></span>
...
|:---|:---|
|<span data-ttu-id="16692-121">Authorization</span><span class="sxs-lookup"><span data-stu-id="16692-121">Authorization</span></span>|<span data-ttu-id="16692-122">Se requiere &lt;token&gt; de portador.</span><span class="sxs-lookup"><span data-stu-id="16692-122">Bearer &lt;token&gt; Required.</span></span>|
|<span data-ttu-id="16692-123">Aceptar</span><span class="sxs-lookup"><span data-stu-id="16692-123">Accept</span></span>|<span data-ttu-id="16692-124">application/json</span><span class="sxs-lookup"><span data-stu-id="16692-124">application/json</span></span>|
...
<span data-ttu-id="16692-126">No proporcione un cuerpo de solicitud para este método.</span><span class="sxs-lookup"><span data-stu-id="16692-126">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="16692-127">Respuesta</span><span class="sxs-lookup"><span data-stu-id="16692-127">Response</span></span>
<span data-ttu-id="16692-128">Si se ejecuta correctamente, este método devuelve un código de respuesta `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="16692-128">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="16692-129">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="16692-129">Example</span></span>
### <a name="request"></a><span data-ttu-id="16692-130">Solicitud</span><span class="sxs-lookup"><span data-stu-id="16692-130">Request</span></span>
<span data-ttu-id="16692-131">Aquí tiene un ejemplo de la solicitud.</span><span class="sxs-lookup"><span data-stu-id="16692-131">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="16692-132">Respuesta</span><span class="sxs-lookup"><span data-stu-id="16692-132">Response</span></span>

...
Borrar valores de rango, formato, relleno, borde, etc.
...
|:---------------|:--------|:----------|
|applyTo|string|Opcional. Determina el tipo de acción Borrar.  Los valores posibles son: `All`, `Formats`, `Contents`.|

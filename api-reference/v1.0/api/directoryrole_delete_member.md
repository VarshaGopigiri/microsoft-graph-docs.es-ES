# <a name="remove-directory-role-member"></a><span data-ttu-id="4e5f5-101">Eliminar miembro del rol de directorio</span><span class="sxs-lookup"><span data-stu-id="4e5f5-101">Remove directory role member</span></span>

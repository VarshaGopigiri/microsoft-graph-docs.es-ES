...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y el objeto [WorkbookTableColumn](../resources/tablecolumn.md) actualizado en el cuerpo de la respuesta.

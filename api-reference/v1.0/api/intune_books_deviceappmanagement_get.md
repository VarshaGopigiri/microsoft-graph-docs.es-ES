...
Lea las propiedades y las relaciones del objeto [deviceAppManagement](../resources/intune_books_deviceappmanagement.md).
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y un objeto [deviceAppManagement](../resources/intune_books_deviceappmanagement.md) en el cuerpo de la respuesta.

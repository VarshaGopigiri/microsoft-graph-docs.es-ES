...
Lea las propiedades y las relaciones del objeto [managedApp](../resources/intune_apps_managedapp.md).
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y el objeto [managedApp](../resources/intune_apps_managedapp.md) en el cuerpo de la respuesta.

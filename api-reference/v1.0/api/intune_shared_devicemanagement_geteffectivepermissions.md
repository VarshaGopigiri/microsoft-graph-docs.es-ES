...
Si se ejecuta correctamente, esta función devuelve un código de respuesta `200 OK` y una colección [rolePermission](../resources/intune_rbac_rolepermission.md) en el cuerpo de la respuesta.

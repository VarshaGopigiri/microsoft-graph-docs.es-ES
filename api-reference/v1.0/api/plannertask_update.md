...
|bucketId|Cadena|Identificador de cubo al que pertenece la tarea. El cubo debe estar en el plan en el que la tarea se encuentra. Tiene 28 caracteres y distingue mayúsculas y minúsculas. La [validación de formato](../resources/planner_identifiers_disclaimer.md) se realiza en el servicio. |

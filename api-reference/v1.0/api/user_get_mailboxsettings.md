# <a name="get-user-mailbox-settings"></a><span data-ttu-id="39f41-101">Obtener configuración del buzón del usuario</span><span class="sxs-lookup"><span data-stu-id="39f41-101">Get user mailbox settings</span></span>

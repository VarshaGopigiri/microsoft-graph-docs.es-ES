...
Lea las propiedades y las relaciones del objeto [user](../resources/intune_onboarding_user.md).
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y el objeto [user](../resources/intune_onboarding_user.md) en el cuerpo de la respuesta.

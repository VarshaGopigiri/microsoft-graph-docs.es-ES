...
Cree un objeto [user](../resources/intune_mam_user.md).
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `201 Created` y un objeto [user](../resources/intune_mam_user.md) en el cuerpo de la respuesta.

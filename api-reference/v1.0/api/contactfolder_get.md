...
Obtiene una carpeta de contactos mediante el identificador de carpeta de contactos.
## <a name="prerequisites"></a>Requisitos previos
Se requiere uno de los siguientes **ámbitos** para ejecutar esta API: *Contacts.ReadWrite; Contacts.Read*

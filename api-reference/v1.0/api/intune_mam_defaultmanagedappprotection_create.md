...
|appDataEncryptionType|String|Tipo de cifrado que debe usarse para los datos en una aplicación administrada. (Solo para iOS) Los valores posibles son: `useDeviceSettings`, `afterDeviceRestart`, `whenDeviceLockedExceptOpenFiles` y `whenDeviceLocked`.|
|screenCaptureBlocked|Boolean|Indica si se bloquea la captura de pantalla.|

# <a name="get-chartseries"></a>Obtener ChartSeries
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y el objeto [WorkbookChartSeries](../resources/chartseries.md) en el cuerpo de la respuesta.

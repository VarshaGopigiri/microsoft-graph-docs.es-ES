...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y el objeto [WorkbookChartAxis](../resources/chartaxis.md) en el cuerpo de la respuesta.

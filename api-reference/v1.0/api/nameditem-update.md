...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y el objeto [WorkbookNamedItem](../resources/nameditem.md) actualizado en el cuerpo de la respuesta.

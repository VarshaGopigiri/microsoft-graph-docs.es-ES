...
Obtener todos los objetos [messageRule](../resources/messagerule.md) definidos para la Bandeja de entrada del usuario.
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y la colección de objetos [messageRule](../resources/messagerule.md) en el cuerpo de la respuesta.

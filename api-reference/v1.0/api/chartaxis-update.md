...
---
# <a name="update-chartaxis"></a>Actualizar chartaxis

Actualizar las propiedades del objeto chartaxis.
...
|minorUnit|Json|Representa el intervalo entre dos marcas de graduación secundarias. Puede establecerse en un valor numérico o en una cadena vacía (para valores de eje automáticos). El valor devuelto siempre es un número.|

## <a name="response"></a>Respuesta

Si tiene éxito, este método devuelve una `200 OK` código de respuesta y el objeto [WorkbookChartAxis](../resources/chartaxis.md) actualizado en el cuerpo de la respuesta.

# <a name="renewupload-action"></a><span data-ttu-id="b4e60-101">Acción renewUpload</span><span class="sxs-lookup"><span data-stu-id="b4e60-101">renewUpload action</span></span>

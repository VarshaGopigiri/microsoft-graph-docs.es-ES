# <a name="locatedevice-action"></a><span data-ttu-id="de1e2-101">Acción locateDevice</span><span class="sxs-lookup"><span data-stu-id="de1e2-101">locateDevice action</span></span>

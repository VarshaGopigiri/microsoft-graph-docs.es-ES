...
Cree un objeto [detectedApp](../resources/intune-devices-detectedapp.md).
...
En la tabla siguiente se muestran las propiedades necesarias para crear el objeto detectedApp.
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `201 Created` y un objeto [detectedApp](../resources/intune-devices-detectedapp.md) en el cuerpo de la respuesta.

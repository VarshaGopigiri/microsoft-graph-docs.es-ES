...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y la colección de objetos [WorkbookChartPoint](../resources/chartpoint.md) en el cuerpo de la respuesta.

...
Este es un ejemplo de la respuesta, que muestra las propiedades **start** y **end** que usan la zona horaria especificada en el encabezado `Prefer: outlook.timezone`. Nota: Es posible que el objeto de respuesta que aparezca aquí esté truncado para abreviar. Todas las propiedades se devolverán desde una llamada real.
<!-- {
  "blockType": "response",
  "name": "create_event_from_user",
  "truncated": true,

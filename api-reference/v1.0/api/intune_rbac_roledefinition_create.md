...
Cree un objeto [roleDefinition](../resources/intune_rbac_roledefinition.md).
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `201 Created` y un objeto [roleDefinition](../resources/intune_rbac_roledefinition.md) en el cuerpo de la respuesta.

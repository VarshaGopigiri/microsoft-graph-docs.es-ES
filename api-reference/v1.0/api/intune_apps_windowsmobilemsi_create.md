...
Crear un objeto [windowsMobileMSI](../resources/intune_apps_windowsmobilemsi.md).
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `201 Created` y un objeto [windowsMobileMSI](../resources/intune_apps_windowsmobilemsi.md) en el cuerpo de la respuesta.

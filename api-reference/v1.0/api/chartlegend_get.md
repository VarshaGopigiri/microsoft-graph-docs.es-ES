...
Recupera las propiedades y relaciones del objeto chartlegend.
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y el objeto [ChartLegend](../resources/chartlegend.md) en el cuerpo de la respuesta.

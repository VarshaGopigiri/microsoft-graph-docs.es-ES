...
Lea las propiedades y las relaciones del objeto [iosStoreApp](../resources/intune_apps_iosstoreapp.md).
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y el objeto [iosStoreApp](../resources/intune_apps_iosstoreapp.md) en el cuerpo de la respuesta.

# <a name="get-chartfont"></a>Obtener ChartFont

Recuperar las propiedades y relaciones del objeto chartfont.
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y el objeto [WorkbookChartFont](../resources/chartfont.md) en el cuerpo de la respuesta.

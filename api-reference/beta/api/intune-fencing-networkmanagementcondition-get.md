...
Leer las propiedades y las relaciones del objeto [networkManagementCondition](../resources/intune-fencing-networkmanagementcondition.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [networkManagementCondition](../resources/intune-fencing-networkmanagementcondition.md) de respuesta en el cuerpo de la respuesta.

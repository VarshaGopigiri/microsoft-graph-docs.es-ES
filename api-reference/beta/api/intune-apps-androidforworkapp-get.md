...
Leer las propiedades y las relaciones del objeto [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) de respuesta en el cuerpo de la respuesta.

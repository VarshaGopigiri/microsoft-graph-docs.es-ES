...
Obtiene el número de usuarios únicos por aplicación de correo electrónico.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[emailAppUsageAppsUserCounts](../resources/emailappusageappsusercounts.md)** en el cuerpo de la respuesta.

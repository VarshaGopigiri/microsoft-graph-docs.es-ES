...
Obtiene el número de usuarios únicos que se conectaron a Exchange Online con cualquier aplicación de correo electrónico.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[emailAppUsageUserCounts](../resources/emailappusageusercounts.md)** en el cuerpo de la respuesta.

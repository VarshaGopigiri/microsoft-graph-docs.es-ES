...
Crear un nuevo objeto [enrollmentProfile](../resources/intune-enrollment-enrollmentprofile.md) .
...
La siguiente tabla muestran las propiedades que son necesarias cuando se crea el enrollmentProfile.
...
Si tiene éxito, este método devuelve una `201 Created` código de respuesta y un objeto [enrollmentProfile](../resources/intune-enrollment-enrollmentprofile.md) en el cuerpo de la respuesta.

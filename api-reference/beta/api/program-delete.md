...
En la característica de [acceso revisa](../resources/accessreviews-root.md) Azure AD, eliminar un objeto de [programa](../resources/program.md) .

No elimine un programa que todavía tiene `programControl` vinculados a ella, las revisiones de access deben primero eliminarse o desvincula desde el programa y vinculadas a otro programa.  Además, tenga en cuenta que no se puede eliminar el programa predeterminado integrado.

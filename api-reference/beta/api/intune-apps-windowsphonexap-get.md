...
Leer las propiedades y las relaciones del objeto [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) de respuesta en el cuerpo de la respuesta.

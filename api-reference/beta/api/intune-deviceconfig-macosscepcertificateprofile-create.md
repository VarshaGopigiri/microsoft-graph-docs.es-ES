...
Crear un nuevo objeto [macOSScepCertificateProfile](../resources/intune-deviceconfig-macosscepcertificateprofile.md) .
...
En el cuerpo de la solicitud, proporcionar una representación de JSON para el objeto macOSScepCertificateProfile.

La siguiente tabla muestran las propiedades que son necesarias cuando se crea el macOSScepCertificateProfile.
...
Si tiene éxito, este método devuelve una `201 Created` código de respuesta y un objeto [macOSScepCertificateProfile](../resources/intune-deviceconfig-macosscepcertificateprofile.md) en el cuerpo de la respuesta.

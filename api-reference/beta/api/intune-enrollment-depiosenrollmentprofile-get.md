...
Leer las propiedades y las relaciones del objeto [depIOSEnrollmentProfile](../resources/intune-enrollment-depiosenrollmentprofile.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [depIOSEnrollmentProfile](../resources/intune-enrollment-depiosenrollmentprofile.md) de respuesta en el cuerpo de la respuesta.

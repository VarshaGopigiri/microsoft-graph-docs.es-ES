...
Recuperar una lista de objetos de privilegedapproval.

Para filtrar los resultados de la consulta, use el estándar OData ``$filter`` expresiones en los URI.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [privilegedApproval](../resources/privilegedapproval.md) en el cuerpo de la respuesta.

...
---
# <a name="privilegedroleassignmentrequest-my"></a>privilegedRoleAssignmentRequest: Mi

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Obtenga las solicitudes de asignación de roles con privilegios del solicitante.
...
Si tiene éxito, este método devuelve `200 OK` objeto de colección de respuesta código y [privilegedRoleAssignmentRequest](../resources/privilegedroleassignmentrequest.md) en el cuerpo de la respuesta.

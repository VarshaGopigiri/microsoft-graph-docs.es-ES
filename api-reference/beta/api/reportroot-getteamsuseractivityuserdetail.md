...
Obtenga información sobre la actividad de usuario de Microsoft Teams por usuario.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[teamsUserActivityUserDetail](../resources/teamsuseractivityuserdetail.md)** en el cuerpo de la respuesta.

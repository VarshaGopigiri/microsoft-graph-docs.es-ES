...
En este ejemplo se usa el `Prefer: outlook.timezone` encabezado para especificar la visualización de las propiedades de fecha y hora en la respuesta en hora estándar del Pacífico.
<!-- {
  "blockType": "request",
  "name": "get_outlooktask"
}-->

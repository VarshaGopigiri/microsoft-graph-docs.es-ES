...
---
# <a name="list-serviceprincipal-memberof"></a>Miembro de lista servicePrincipal

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Obtener los grupos y roles de Active directory que este servicio principal es miembro directo. Esta operación no es transitiva.

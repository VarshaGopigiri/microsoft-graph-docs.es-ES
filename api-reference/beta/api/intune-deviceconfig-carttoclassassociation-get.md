...
Leer las propiedades y las relaciones del objeto [cartToClassAssociation](../resources/intune-deviceconfig-carttoclassassociation.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [cartToClassAssociation](../resources/intune-deviceconfig-carttoclassassociation.md) de respuesta en el cuerpo de la respuesta.

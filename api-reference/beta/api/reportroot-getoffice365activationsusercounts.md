...
Obtener el recuento de usuarios que están habilitados y aquellos que tienen activada la suscripción de Office en el escritorio o dispositivos o equipos compartidos.
...
- Asignado
- Activado
- Activación de equipo compartido

### <a name="json"></a>JSON

Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[office365ActivationsUserCounts](../resources/office365activationsusercounts.md)** en el cuerpo de la respuesta.

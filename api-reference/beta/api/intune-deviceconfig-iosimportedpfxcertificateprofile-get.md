...
Leer las propiedades y las relaciones del objeto [iosImportedPFXCertificateProfile](../resources/intune-deviceconfig-iosimportedpfxcertificateprofile.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [iosImportedPFXCertificateProfile](../resources/intune-deviceconfig-iosimportedpfxcertificateprofile.md) de respuesta en el cuerpo de la respuesta.

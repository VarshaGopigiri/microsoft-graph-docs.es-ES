...
Obtener la colección de objetos [bookingAppointment](../resources/bookingappointment.md) para un [bookingBusiness](../resources/bookingbusiness.md), que se produce en el intervalo de fechas especificado.
...
Si tiene éxito, este método devuelve `200, OK` objeto de colección de respuesta código y [bookingAppointment](../resources/bookingappointment.md) en el cuerpo de la respuesta.

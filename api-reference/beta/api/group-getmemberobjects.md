...
Devolver todos los grupos y unidades administrativas que el grupo es un miembro de. La comprobación es transitiva. Nota: Los grupos no pueden ser miembros de los roles de Active directory, por lo que no se devolverá ninguna función de Active directory.

...
---
# <a name="getmobileappcount-function"></a>getMobileAppCount (función)
...
Si tiene éxito, esta función devuelve una `200 OK` código de respuesta y un Int64 en el cuerpo de la respuesta.

...
Obtiene el número de usuarios diario por tipo de dispositivo.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[yammerDeviceUsageUserCounts](../resources/yammerdeviceusageusercounts.md)** en el cuerpo de la respuesta.

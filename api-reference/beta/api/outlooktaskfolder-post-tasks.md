...
Crear una tarea de Outlook en la carpeta de la tarea especificada.
...
En el cuerpo de la solicitud, proporcionar una representación JSON del objeto [outlookTask](../resources/outlooktask.md) .
##### <a name="response"></a>Respuesta
El método POST omite la parte de tiempo en el cuerpo de la solicitud y se da por supuesto la hora a estar siempre medianoche en la zona horaria especificada (PST). A continuación, de forma predeterminada, el método POST convierte y muestra todas las propiedades relacionadas con la fecha en UTC en la respuesta.

...
Leer las propiedades y las relaciones del objeto [ndesConnector](../resources/intune-deviceconfig-ndesconnector.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [ndesConnector](../resources/intune-deviceconfig-ndesconnector.md) de respuesta en el cuerpo de la respuesta.

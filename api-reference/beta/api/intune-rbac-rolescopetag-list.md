...
Propiedades de la lista y relaciones de los objetos [roleScopeTag](../resources/intune-rbac-rolescopetag.md) .
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y una colección de objetos de [roleScopeTag](../resources/intune-rbac-rolescopetag.md) en el cuerpo de la respuesta.

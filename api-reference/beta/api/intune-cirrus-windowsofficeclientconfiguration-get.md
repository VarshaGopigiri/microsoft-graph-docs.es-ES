...
Obtener un objeto de directiva de seguridad que no sean específicos [windowsOfficeClientConfiguration](../resources/intune-cirrus-windowsofficeclientconfiguration.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [windowsOfficeClientConfiguration](../resources/intune-cirrus-windowsofficeclientconfiguration.md) de respuesta en el cuerpo de la respuesta.

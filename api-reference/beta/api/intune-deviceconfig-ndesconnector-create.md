...
Crear un nuevo objeto [ndesConnector](../resources/intune-deviceconfig-ndesconnector.md) .
...
En el cuerpo de la solicitud, proporcionar una representación de JSON para el objeto ndesConnector.

La siguiente tabla muestran las propiedades que son necesarias cuando se crea el ndesConnector.
...
Si tiene éxito, este método devuelve una `201 Created` código de respuesta y un objeto [ndesConnector](../resources/intune-deviceconfig-ndesconnector.md) en el cuerpo de la respuesta.

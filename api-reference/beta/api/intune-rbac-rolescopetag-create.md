...
Crear un nuevo objeto [roleScopeTag](../resources/intune-rbac-rolescopetag.md) .
...
En el cuerpo de la solicitud, proporcionar una representación de JSON para el objeto roleScopeTag.

La siguiente tabla muestran las propiedades que son necesarias cuando se crea el roleScopeTag.
...
Si tiene éxito, este método devuelve una `201 Created` código de respuesta y un objeto [roleScopeTag](../resources/intune-rbac-rolescopetag.md) en el cuerpo de la respuesta.

...
Crear un reemplazo [Dirigidos a Bandeja de entrada](../resources/manage-focused-inbox.md) para un remitente identificado por una dirección SMTP. Mensajes futuros de la que se va a clasificar coherentemente dirección SMTP como se especifica en el reemplazo.

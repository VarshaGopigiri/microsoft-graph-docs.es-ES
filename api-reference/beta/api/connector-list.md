...
Recuperar una lista de los objetos del conector.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [conector](../resources/connector.md) en el cuerpo de la respuesta.

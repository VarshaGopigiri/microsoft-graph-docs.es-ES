...
Obtiene el número de buzones de usuario en cada categoría de cuota.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[mailboxUsageQuotaStatusMailboxCounts](../resources/mailboxusagequotastatusmailboxcounts.md)** en el cuerpo de la respuesta.

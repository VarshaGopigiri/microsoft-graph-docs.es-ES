...
---
# <a name="get-outlooktaskgroup"></a>Obtener outlookTaskGroup

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Obtener las propiedades y relaciones del grupo de tareas de Outlook especificado.
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [outlookTaskGroup](../resources/outlooktaskgroup.md) de respuesta en el cuerpo de la respuesta.

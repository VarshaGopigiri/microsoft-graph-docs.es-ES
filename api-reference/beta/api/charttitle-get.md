...
Recuperar las propiedades y relaciones del objeto charttitle.
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y el objeto [ChartTitle](../resources/charttitle.md) en el cuerpo de la respuesta.

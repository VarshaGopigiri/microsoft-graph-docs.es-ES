...
Recuperar las propiedades y las relaciones del objeto chartaxis.
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y el objeto [ChartAxis](../resources/chartaxis.md) en el cuerpo de la respuesta.

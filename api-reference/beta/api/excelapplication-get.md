...
Recuperar las propiedades y relaciones del objeto application.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y el objeto de [aplicación](../resources/application.md) en el cuerpo de la respuesta.

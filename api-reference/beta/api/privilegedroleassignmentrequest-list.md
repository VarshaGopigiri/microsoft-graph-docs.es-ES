...
Recuperar una colección de [privilegedRoleAssignmentRequest](../resources/privilegedroleassignmentrequest.md). 

**Nota:** Este solicitante debe tener al menos una asignación de funciones en el recurso.
...
|:--------------------------------------|:---------------------------------------------------------|
|Delegado (cuenta profesional o educativa) | PrivilegedAccess.ReadWrite.AzureAD, Directory.Read.All, Directory.AccessAsUser.All    |
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y una colección de objetos de [privilegedRoleAssignmentRequest](../resources/privilegedroleassignmentrequest.md) en el cuerpo de la respuesta.

...
Crear un borrador de mensaje de reenvío para incluir un comentario o actualizar las propiedades de mensaje  
todo en una **createForward** la llamada. A continuación, puede [Enviar](../api/message-send.md) el mensaje de borrador.

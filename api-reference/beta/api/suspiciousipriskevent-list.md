...
Recuperar una lista de objetos de suspiciousipriskevent.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [suspiciousIpRiskEvent](../resources/suspiciousipriskevent.md) en el cuerpo de la respuesta.

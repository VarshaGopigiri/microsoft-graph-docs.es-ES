...
---
# <a name="create-androideasemailprofileconfiguration"></a>Crear androidEasEmailProfileConfiguration

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

> **Nota:** El uso de las API de Microsoft Graph para configurar las directivas y los controles de Intune requiere que el cliente tenga la [licencia correcta](https://go.microsoft.com/fwlink/?linkid=839381) para el servicio Intune.

Crear un nuevo objeto [androidEasEmailProfileConfiguration](../resources/intune-deviceconfig-androideasemailprofileconfiguration.md) .
...
En el cuerpo de la solicitud, proporcionar una representación de JSON para el objeto androidEasEmailProfileConfiguration.

La siguiente tabla muestran las propiedades que son necesarias cuando se crea el androidEasEmailProfileConfiguration.
...
|syncCalendar|Boolean|Activa o desactiva la sincronización del calendario. Si se establece en false calendario está desactivado en el dispositivo.|
...
|syncNotes|Boolean|Activa o desactiva la sincronización de notas. Si establece en false notas está desactivado en el dispositivo.|
...
Si tiene éxito, este método devuelve una `201 Created` código de respuesta y un objeto [androidEasEmailProfileConfiguration](../resources/intune-deviceconfig-androideasemailprofileconfiguration.md) en el cuerpo de la respuesta.

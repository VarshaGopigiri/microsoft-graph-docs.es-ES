...
Este método también admite los [parámetros de consulta de OData](/graph/query-parameters) a modo de ayuda para personalizar la respuesta.
...
En el ejemplo siguiente, se solicita la devolución de cuerpos de evento en texto sin formato.
<!-- {
  "blockType": "request",

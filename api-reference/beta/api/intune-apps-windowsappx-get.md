...
Leer las propiedades y las relaciones del objeto [windowsAppX](../resources/intune-apps-windowsappx.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [windowsAppX](../resources/intune-apps-windowsappx.md) de respuesta en el cuerpo de la respuesta.

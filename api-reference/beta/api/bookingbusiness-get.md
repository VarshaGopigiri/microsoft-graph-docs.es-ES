...
---
# <a name="get-bookingbusiness"></a>Obtener bookingBusiness

 > **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.
 
Obtener las propiedades y relaciones de un objeto [bookingBusiness](../resources/bookingbusiness.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [bookingBusiness](../resources/bookingbusiness.md) de respuesta en el cuerpo de la respuesta.

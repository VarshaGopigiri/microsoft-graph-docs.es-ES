...
Obtiene la cantidad de almacenamiento usado en la organización.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[mailboxUsageStorage](../resources/mailboxusagestorage.md)** en el cuerpo de la respuesta.

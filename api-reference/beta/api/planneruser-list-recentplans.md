...
Recuperar una lista de [plannerPlans](../resources/plannerplan.md) visto recientemente por un usuario. Puede actualizar planes vistos recientemente mediante la [actualización de los recursos de plannerUser](planneruser-update.md).

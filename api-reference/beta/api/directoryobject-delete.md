...
**Nota:** Los usuarios, grupos y contactos son tipos de objeto de Active directory. Como resultado, si necesita eliminar los usuarios, el permiso siguiente puede y debe usarse: User.ReadWrite.All

...
---
# <a name="get-oauth2permissiongrant"></a>Obtener oAuth2Permissiongrant

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Recuperar las propiedades y relaciones del objeto oAuth2Permissiongrant.
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [oAuth2Permissiongrant](../resources/oauth2permissiongrant.md) de respuesta en el cuerpo de la respuesta.

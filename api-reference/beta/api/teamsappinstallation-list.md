...
Recuperar la lista de [aplicaciones instalado](../resources/teamsappinstallation.md) en el [equipo](../resources/team.md)de especificado.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [teamsApp](../resources/teamsapp.md) en el cuerpo de la respuesta.
...
## <a name="example----getting-the-names-of-the-installed-apps"></a>Ejemplo: obtener los nombres de las aplicaciones instaladas

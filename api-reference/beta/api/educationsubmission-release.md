...
---
# <a name="educationsubmission-release"></a>educationSubmission: versión

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Esta acción hace que la calificación y comentarios asociados con este envío disponible para los estudiantes. Esto cambiará el estado de la presentación de "enviada" a "publicada" y se indica que se ha realizado la clasificación. Esta acción sólo puede realizarse por el profesor.

...
Recuperar una lista de objetos de unfamiliarlocationriskevent.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [unfamiliarLocationRiskEvent](../resources/unfamiliarlocationriskevent.md) en el cuerpo de la respuesta.

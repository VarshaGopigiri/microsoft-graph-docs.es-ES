...
Recuperar las propiedades y relaciones de un [canal](../resources/channel.md).
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto de [canal](../resources/channel.md) en el cuerpo de la respuesta.

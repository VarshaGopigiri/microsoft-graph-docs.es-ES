...
Obtener las carpetas de tareas de Outlook en un determinado [outlookTaskGroup](../resources/outlooktaskgroup.md).
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [outlookTaskFolder](../resources/outlooktaskfolder.md) en el cuerpo de la respuesta.

...
---
# <a name="list-the-pages-in-the-site-pages-list-of-a-site"></a>Lista de las páginas en la lista de páginas de sitio de un sitio

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Obtener la colección de [] [sitePages] de la de las páginas de sitio [lista][] en un sitio del [sitio][]. Se devuelven todas las páginas del sitio (con paginación).

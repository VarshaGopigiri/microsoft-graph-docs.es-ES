...
Leer las propiedades y las relaciones del objeto [androidForWorkNineWorkEasConfiguration](../resources/intune-deviceconfig-androidforworknineworkeasconfiguration.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [androidForWorkNineWorkEasConfiguration](../resources/intune-deviceconfig-androidforworknineworkeasconfiguration.md) de respuesta en el cuerpo de la respuesta.

...
Crear un nuevo objeto [sideLoadingKey](../resources/intune-onboarding-sideloadingkey.md) .
...
En el cuerpo de la solicitud, proporcionar una representación de JSON para el objeto sideLoadingKey.

La siguiente tabla muestran las propiedades que son necesarias cuando se crea el sideLoadingKey.
...
Si tiene éxito, este método devuelve una `201 Created` código de respuesta y un objeto [sideLoadingKey](../resources/intune-onboarding-sideloadingkey.md) en el cuerpo de la respuesta.

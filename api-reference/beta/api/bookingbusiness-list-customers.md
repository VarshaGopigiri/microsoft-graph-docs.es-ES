...
Obtener una lista de objetos de [bookingCustomer](../resources/bookingcustomer.md) .
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [bookingCustomer](../resources/bookingcustomer.md) en el cuerpo de la respuesta.

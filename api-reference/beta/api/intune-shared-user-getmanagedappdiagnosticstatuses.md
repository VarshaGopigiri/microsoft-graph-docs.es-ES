...
Obtiene estados de validación de diagnósticos de un usuario determinado.
...
Si se ejecuta correctamente, esta función devuelve un código de respuesta `200 OK` y una colección [managedAppDiagnosticStatus](../resources/intune-mam-managedappdiagnosticstatus.md) en el cuerpo de la respuesta.

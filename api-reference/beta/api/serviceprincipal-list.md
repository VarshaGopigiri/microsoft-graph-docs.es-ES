...
Recuperar una lista de objetos de servicePrincipal.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [servicePrincipal](../resources/serviceprincipal.md) en el cuerpo de la respuesta.

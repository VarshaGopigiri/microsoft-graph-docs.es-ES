...
Hacer que la asignación de rol como permanente.

## <a name="permissions"></a>Permisos
Se requiere uno de los siguientes permisos para llamar a esta API. Para obtener más información, incluido cómo elegir permisos, vea [Permisos](/graph/permissions-reference).

El inquilino debe estar registrado en PIM. De lo contrario, se devolverá error HTTP 403 Prohibido.
...
|:---------------|:--------|:----------|
|motivo|string|Opcional. La razón para realizar esta llamada.|
|ticketNumber|string|Opcional. El número de vale que está asociado con esta acción.|

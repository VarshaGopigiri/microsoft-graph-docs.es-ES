...
Recuperar las propiedades y relaciones del objeto tablesort.
...
Si se ejecuta correctamente, este método devuelve un código de respuesta `200 OK` y el objeto [TableSort](../resources/tablesort.md) en el cuerpo de la respuesta.

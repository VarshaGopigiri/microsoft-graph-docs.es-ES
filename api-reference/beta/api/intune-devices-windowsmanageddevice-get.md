...
Leer las propiedades y las relaciones del objeto [windowsManagedDevice](../resources/intune-devices-windowsmanageddevice.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [windowsManagedDevice](../resources/intune-devices-windowsmanageddevice.md) de respuesta en el cuerpo de la respuesta.

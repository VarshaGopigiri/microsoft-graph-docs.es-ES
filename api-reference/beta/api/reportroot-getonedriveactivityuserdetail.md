...
Obtiene información sobre las actividades de OneDrive por usuario.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[oneDriveActivityUserDetail](../resources/onedriveactivityuserdetail.md)** en el cuerpo de la respuesta.

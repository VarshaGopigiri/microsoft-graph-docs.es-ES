...
Recuperar una lista de objetos de [extremo](../resources/endpoint.md) .
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [extremo](../resources/endpoint.md) en el cuerpo de la respuesta.

...
Recuperar una lista de objetos de impossibletravelriskevent.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [impossibleTravelRiskEvent](../resources/impossibletravelriskevent.md) en el cuerpo de la respuesta.

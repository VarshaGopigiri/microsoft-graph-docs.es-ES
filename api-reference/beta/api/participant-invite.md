...
Invitar a participantes a la llamada activa.
...
| Aplicación     | Calls.InitiateGroupCalls.All                               |
...
Los siguientes ejemplos se muestra cómo llamar a esta API.
...
### <a name="invite-participants-in-existing-p2p-meeting"></a>Invitar a los participantes de la reunión P2P existente
...
##### <a name="notification---roster-updated-with-participant-added"></a>Notificación: lista de participantes se actualizó con participante agregado
...
En este ejemplo se muestra un flujo de E2E completado para [Invitar a los participantes](../api/participant-invite.md) en una reunión de P2P existente.

##### <a name="answer-incoming-voip-call-with-service-hosted-media"></a>Responder a la llamada entrante VOIP con medios de servicio hospedado

##### <a name="notification---incoming"></a>Notificación - entrante
...
### <a name="join-channel-meeting-without-media"></a>Unirse a reuniones de canal sin medios

> **Importante**: si va a unirse la instancia de bot sólo con el fin de facilitar la transferencia, deben evitar las negociaciones de medios.  Por lo tanto, es mejor agregar sin ninguna `requestedModalities` o `mediaConfig`.
...
### <a name="invite-participant-from-initial-incoming-call"></a>Invitar a participantes de llamada entrante inicial
...
##### <a name="notification---terminated-the-original-p2p-call"></a>Notificación - terminada la llamada original de P2P
...
##### <a name="notification---deleted-the-original-p2p-call"></a>Notificación - elimina la llamada original de P2P

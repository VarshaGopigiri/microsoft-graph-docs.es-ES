...
---
# <a name="create-application"></a>Crear la aplicación

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Utilice esta API para crear una nueva aplicación.
...
En el cuerpo de la solicitud, proporcionar una representación JSON del objeto [application](../resources/application.md) .

## <a name="response"></a>Respuesta

Si tiene éxito, este método devuelve `201 Created` objeto de código y la [aplicación](../resources/application.md) de respuesta en el cuerpo de la respuesta.

...
|:--------------------|:---------------------------------------------------------|
|Delegado (cuenta profesional o educativa) | Group.ReadBasic.All, Group.Read.All, Group.ReadWrite.All    |
|Delegado (cuenta Microsoft personal) | No admitida.    |
|Aplicación | Group.ReadBasic.All, Group.Read.All, Group.ReadWrite.All |

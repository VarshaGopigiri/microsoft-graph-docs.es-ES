...
En la característica de [acceso revisa](../resources/accessreviews-root.md) Azure AD, incluya a todos los objetos de [businessFlowTemplate](../resources/businessflowtemplate.md) .
...
Si tiene éxito, este método devuelve una `200, OK` código de respuesta y una matriz de objetos de [businessFlowTemplate](../resources/businessflowtemplate.md) en el cuerpo de la respuesta.

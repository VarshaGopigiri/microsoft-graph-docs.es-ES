...
Leer las propiedades y las relaciones del objeto [androidForWorkCertificateProfileBase](../resources/intune-deviceconfig-androidforworkcertificateprofilebase.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [androidForWorkCertificateProfileBase](../resources/intune-deviceconfig-androidforworkcertificateprofilebase.md) de respuesta en el cuerpo de la respuesta.

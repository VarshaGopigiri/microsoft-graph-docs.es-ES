...
|replacesCallId|String|Identificador de llamada original del participante que se va a transferir.|
...
### <a name="transfer-call-directly-with-no-user-involvement"></a>Transferir la llamada directamente, con sin intervención del usuario
...
##### <a name="notification---transferring"></a>Notificación - transferencia
...
##### <a name="notification---transfer-accepted"></a>Notificación - transferencia aceptado
...
##### <a name="notification---terminated"></a>Notificación - terminada
...
### <a name="consultative-transfer"></a>Transferencia de consulta

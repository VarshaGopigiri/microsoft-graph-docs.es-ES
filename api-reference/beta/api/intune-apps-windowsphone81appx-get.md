...
Leer las propiedades y las relaciones del objeto [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) de respuesta en el cuerpo de la respuesta.

...
Recuperar una lista de objetos de [privilegedRoleAssignment](../resources/privilegedroleassignment.md) , que corresponden a todas las asignaciones de roles para la organización.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [privilegedRoleAssignment](../resources/privilegedroleassignment.md) en el cuerpo de la respuesta.
...
### <a name="get-all-role-assignments"></a>Obtener todas las asignaciones de roles
##### <a name="request"></a>Solicitud
En el ejemplo siguiente se muestra una solicitud para obtener todas las asignaciones de roles:
<!-- {
  "blockType": "request",
...
```
### <a name="get-active-role-assignments"></a>Obtener las asignaciones de rol activo
##### <a name="request"></a>Solicitud 
En el ejemplo siguiente se muestra una solicitud para las asignaciones de rol activo de consulta:
<!-- {
  "blockType": "request",
  "name": "get_privilegedroleassignments"
}-->
...
```
### <a name="get-permanent-role-assignments"></a>Obtener las asignaciones de roles permanente
##### <a name="request"></a>Solicitud 
En el ejemplo siguiente se muestra una solicitud para asignaciones de roles permanente de consulta, donde ``expirationDateTime`` valor es ``null``:
<!-- {
  "blockType": "request",
  "name": "get_privilegedroleassignments"
}-->
...
```
### <a name="get-eligible-role-assignments"></a>Obtener las asignaciones de roles optan
##### <a name="request"></a>Solicitud 
En el ejemplo siguiente se muestra una solicitud para las asignaciones de funciones optan de consulta, incluidos los que no está activo y active:
<!-- {
  "blockType": "request",
  "name": "get_privilegedroleassignments"
}-->

...
Leer las propiedades y las relaciones del objeto [enrollmentProfile](../resources/intune-enrollment-enrollmentprofile.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [enrollmentProfile](../resources/intune-enrollment-enrollmentprofile.md) de respuesta en el cuerpo de la respuesta.

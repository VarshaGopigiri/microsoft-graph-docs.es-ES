...
Leer las propiedades y las relaciones del objeto [remoteActionAudit](../resources/intune-devices-remoteactionaudit.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [remoteActionAudit](../resources/intune-devices-remoteactionaudit.md) de respuesta en el cuerpo de la respuesta.

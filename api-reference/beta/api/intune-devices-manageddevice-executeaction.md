...
|:---|:---|:---|
|actionName|[managedDeviceRemoteAction](../resources/intune-devices-manageddeviceremoteaction.md)|Todavía no documentado|
|DeviceID|Colección de cadenas|Todavía no documentado|



## <a name="response"></a>Respuesta
Si tiene éxito, esta acción devuelve un `200 OK` código de respuesta y un [bulkManagedDeviceActionResult](../resources/intune-devices-bulkmanageddeviceactionresult.md) en el cuerpo de la respuesta.

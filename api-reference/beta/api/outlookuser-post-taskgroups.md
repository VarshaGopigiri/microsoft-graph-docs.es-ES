...
---
# <a name="create-outlooktaskgroup"></a>Crear outlookTaskGroup

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Cree un grupo de tareas de Outlook en el buzón del usuario.
...
En el cuerpo de la solicitud, proporcionar una representación JSON del objeto [outlookTaskGroup](../resources/outlooktaskgroup.md) .

## <a name="response"></a>Respuesta

Si tiene éxito, este método devuelve `201 Created` objeto de código y [outlookTaskGroup](../resources/outlooktaskgroup.md) de respuesta en el cuerpo de la respuesta.

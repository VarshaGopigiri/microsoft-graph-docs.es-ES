...
Leer las propiedades y las relaciones del objeto [androidForWorkGeneralDeviceConfiguration](../resources/intune-deviceconfig-androidforworkgeneraldeviceconfiguration.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [androidForWorkGeneralDeviceConfiguration](../resources/intune-deviceconfig-androidforworkgeneraldeviceconfiguration.md) de respuesta en el cuerpo de la respuesta.

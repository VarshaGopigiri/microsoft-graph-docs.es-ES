...
---
# <a name="consenttodatasharing-action"></a>acción consentToDataSharing
...
Si tiene éxito, esta acción devuelve un `200 OK` código de respuesta y un [dataSharingConsent](../resources/intune-devices-datasharingconsent.md) en el cuerpo de la respuesta.

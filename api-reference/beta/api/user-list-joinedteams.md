...
> Actualmente, con los permisos de usuario delegado esta operación sólo funciona para el 'me' usuario. 
> Con permisos de aplicación, funciona para todos los usuarios especificando el identificador de usuario específico. ('' alias no seguirá compatible con los permisos de aplicación) Para obtener más información, vea [problemas conocidos](/graph/known-issues#microsoft-teams-users-list-of-joined-teams-preview).

...
Obtiene información sobre el uso de buzones.
...
- Cuota de advertencia de problema (bytes)
- Cuota de prohibición de envío (bytes)
- Cuota de prohibición de envío o recepción (bytes)
- Período del informe

### <a name="json"></a>JSON

Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[mailboxUsageDetail](../resources/mailboxusagedetail.md)** en el cuerpo de la respuesta.

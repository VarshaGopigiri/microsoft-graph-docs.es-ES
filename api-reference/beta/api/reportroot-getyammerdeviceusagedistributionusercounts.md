...
Obtiene el número de usuarios por tipo de dispositivo.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[yammerDeviceUsageDistributionUserCounts](../resources/yammerdeviceusagedistributionusercounts.md)** en el cuerpo de la respuesta.

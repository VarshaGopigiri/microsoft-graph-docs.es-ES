...
Recuperar la lista de contactos organizativas para esta organización.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y una colección de objetos de [orgContact](../resources/orgcontact.md) en el cuerpo de la respuesta.

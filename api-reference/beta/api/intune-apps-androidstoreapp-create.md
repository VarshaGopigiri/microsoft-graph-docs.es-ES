...
## <a name="http-request"></a><span data-ttu-id="4b1ef-119">Solicitud HTTP</span><span class="sxs-lookup"><span data-stu-id="4b1ef-119">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->

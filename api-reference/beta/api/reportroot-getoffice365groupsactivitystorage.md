...
Obtiene el total de almacenamiento usado en todos los buzones de grupo y sitios de grupo.
...
- Almacenamiento de buzón usado (bytes)
- Almacenamiento de sitio usado (bytes)
- Fecha del informe
- Período del informe

### <a name="json"></a>JSON

Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[office365GroupsActivityStorage](../resources/office365groupsactivitystorage.md)** en el cuerpo de la respuesta.

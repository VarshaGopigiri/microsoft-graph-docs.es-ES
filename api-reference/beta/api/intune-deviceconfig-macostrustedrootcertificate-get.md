...
Leer las propiedades y las relaciones del objeto [macOSTrustedRootCertificate](../resources/intune-deviceconfig-macostrustedrootcertificate.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [macOSTrustedRootCertificate](../resources/intune-deviceconfig-macostrustedrootcertificate.md) de respuesta en el cuerpo de la respuesta.

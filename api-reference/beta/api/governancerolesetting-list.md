...
Recuperar una colección de [governanceRoleSettings](../resources/governancerolesetting.md) en un recurso.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [governanceRoleSetting](../resources/governancerolesetting.md) en el cuerpo de la respuesta.

## <a name="example"></a>Ejemplo
En este ejemplo se muestra cómo un administrador de listas de configuración de las funciones para el recurso Wingtip Toys - Prod. 
<!-- {
  "blockType": "request",

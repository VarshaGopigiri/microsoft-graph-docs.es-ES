...
Recuperar las propiedades de un objeto de conector.
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y el [conector](../resources/connector.md) de respuesta en el cuerpo de la respuesta.

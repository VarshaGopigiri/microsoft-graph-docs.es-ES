...
## <a name="http-request"></a><span data-ttu-id="0d4a0-119">Solicitud HTTP</span><span class="sxs-lookup"><span data-stu-id="0d4a0-119">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
...
|<span data-ttu-id="0d4a0-174">airDropBlocked</span><span class="sxs-lookup"><span data-stu-id="0d4a0-174">airDropBlocked</span></span>|<span data-ttu-id="0d4a0-175">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-175">Boolean</span></span>|<span data-ttu-id="0d4a0-176">Indica si se va a permitir AirDrop cuando el dispositivo está en modo supervisado.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-176">Indicates whether or not to allow AirDrop when the device is in supervised mode.</span></span>|
...
|<span data-ttu-id="0d4a0-225">cameraBlocked</span><span class="sxs-lookup"><span data-stu-id="0d4a0-225">cameraBlocked</span></span>|<span data-ttu-id="0d4a0-226">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-226">Boolean</span></span>|<span data-ttu-id="0d4a0-227">Indica si se va a impedir que el usuario obtenga acceso a la cámara del dispositivo.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-227">Indicates whether or not to block the user from accessing the camera of the device.</span></span>|
...
|<span data-ttu-id="0d4a0-278">diagnosticDataBlockSubmissionModification</span><span class="sxs-lookup"><span data-stu-id="0d4a0-278">diagnosticDataBlockSubmissionModification</span></span>|<span data-ttu-id="0d4a0-279">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-279">Boolean</span></span>|<span data-ttu-id="0d4a0-280">Indica si se va a permitir modificar los ajustes del envío de diagnósticos cuando el dispositivo está en modo supervisado (iOS 9.3.2 o posterior).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-280">Indicates whether or not to allow diagnostics submission settings modification when the device is in supervised mode (iOS 9.3.2 and later).</span></span>|
...
|<span data-ttu-id="0d4a0-308">gameCenterBlocked</span><span class="sxs-lookup"><span data-stu-id="0d4a0-308">gameCenterBlocked</span></span>|<span data-ttu-id="0d4a0-309">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-309">Boolean</span></span>|<span data-ttu-id="0d4a0-310">Indica si se va a impedir que el usuario use el Game Center cuando el dispositivo está en modo supervisado.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-310">Indicates whether or not to block the user from using Game Center when the device is in supervised mode.</span></span>|
...
|<span data-ttu-id="0d4a0-338">iCloudBlockSharedPhotoStream</span><span class="sxs-lookup"><span data-stu-id="0d4a0-338">iCloudBlockSharedPhotoStream</span></span>|<span data-ttu-id="0d4a0-339">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-339">Boolean</span></span>|<span data-ttu-id="0d4a0-340">Indica si se va a bloquear la sincronización de fotos en streaming compartidas.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-340">Indicates whether or not to block Shared Photo Stream.</span></span>|
...
|<span data-ttu-id="0d4a0-365">keyboardBlockSpellCheck</span><span class="sxs-lookup"><span data-stu-id="0d4a0-365">keyboardBlockSpellCheck</span></span>|<span data-ttu-id="0d4a0-366">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-366">Boolean</span></span>|<span data-ttu-id="0d4a0-367">Indica si se va a bloquear la revisión ortográfica cuando el dispositivo está en modo supervisado (iOS 8.1.3 o posterior).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-367">Indicates whether or not to block keyboard spell-checking when the device is in supervised mode (iOS 8.1.3 and later).</span></span>|
...
|<span data-ttu-id="0d4a0-395">kioskModeAllowVolumeButtons</span><span class="sxs-lookup"><span data-stu-id="0d4a0-395">kioskModeAllowVolumeButtons</span></span>|<span data-ttu-id="0d4a0-396">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-396">Boolean</span></span>|<span data-ttu-id="0d4a0-397">Indica si se va a permitir el uso de los botones de volumen en el modo de pantalla completa.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-397">Indicates whether or not to allow use of the volume buttons while in kiosk mode.</span></span>|
...
|<span data-ttu-id="0d4a0-458">mediaContentRatingJapan</span><span class="sxs-lookup"><span data-stu-id="0d4a0-458">mediaContentRatingJapan</span></span>|[<span data-ttu-id="0d4a0-459">mediaContentRatingJapan</span><span class="sxs-lookup"><span data-stu-id="0d4a0-459">mediaContentRatingJapan</span></span>](../resources/intune-deviceconfig-mediacontentratingjapan.md)|<span data-ttu-id="0d4a0-460">Clasificación de contenido multimedia para Japón</span><span class="sxs-lookup"><span data-stu-id="0d4a0-460">Media content rating settings for Japan</span></span>|
...
|<span data-ttu-id="0d4a0-487">passcodeBlockFingerprintModification</span><span class="sxs-lookup"><span data-stu-id="0d4a0-487">passcodeBlockFingerprintModification</span></span>|<span data-ttu-id="0d4a0-488">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-488">Boolean</span></span>|<span data-ttu-id="0d4a0-489">Impide la modificación de huellas digitales registradas de Touch ID en el modo supervisado.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-489">Block modification of registered Touch ID fingerprints when in supervised mode.</span></span>|
...
|<span data-ttu-id="0d4a0-544">safariCookieSettings</span><span class="sxs-lookup"><span data-stu-id="0d4a0-544">safariCookieSettings</span></span>|[<span data-ttu-id="0d4a0-545">webBrowserCookieSettings</span><span class="sxs-lookup"><span data-stu-id="0d4a0-545">webBrowserCookieSettings</span></span>](../resources/intune-deviceconfig-webbrowsercookiesettings.md)|<span data-ttu-id="0d4a0-546">Configuración de cookies para Safari.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-546">Cookie settings for Safari.</span></span> <span data-ttu-id="0d4a0-547">Los valores posibles son: `browserDefault`, `blockAlways`, `allowCurrentWebSite`, `allowFromWebsitesVisited` y `allowAlways`.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-547">Possible values are: `browserDefault`, `blockAlways`, `allowCurrentWebSite`, `allowFromWebsitesVisited`, `allowAlways`.</span></span>|
|<span data-ttu-id="0d4a0-548">safariManagedDomains</span><span class="sxs-lookup"><span data-stu-id="0d4a0-548">safariManagedDomains</span></span>|<span data-ttu-id="0d4a0-549">Colección String</span><span class="sxs-lookup"><span data-stu-id="0d4a0-549">String collection</span></span>|<span data-ttu-id="0d4a0-550">Las direcciones URL que coinciden con los patrones que se enumeran aquí se considerarán administradas.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-550">URLs matching the patterns listed here will be considered managed.</span></span>|
|<span data-ttu-id="0d4a0-551">safariPasswordAutoFillDomains</span><span class="sxs-lookup"><span data-stu-id="0d4a0-551">safariPasswordAutoFillDomains</span></span>|<span data-ttu-id="0d4a0-552">Colección String</span><span class="sxs-lookup"><span data-stu-id="0d4a0-552">String collection</span></span>|<span data-ttu-id="0d4a0-553">Los usuarios pueden guardar las contraseñas en Safari únicamente de las direcciones URL que coinciden con los patrones que se enumeran aquí.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-553">Users can save passwords in Safari only from URLs matching the patterns listed here.</span></span> <span data-ttu-id="0d4a0-554">Se aplica solo a dispositivos en modo supervisado (iOS 9.3 o posterior).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-554">Applies to devices in supervised mode (iOS 9.3 and later).</span></span>|
|<span data-ttu-id="0d4a0-555">safariRequireFraudWarning</span><span class="sxs-lookup"><span data-stu-id="0d4a0-555">safariRequireFraudWarning</span></span>|<span data-ttu-id="0d4a0-556">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-556">Boolean</span></span>|<span data-ttu-id="0d4a0-557">Indica si se va a requerir una advertencia de fraude en Safari.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-557">Indicates whether or not to require fraud warning in Safari.</span></span>|
|<span data-ttu-id="0d4a0-558">screenCaptureBlocked</span><span class="sxs-lookup"><span data-stu-id="0d4a0-558">screenCaptureBlocked</span></span>|<span data-ttu-id="0d4a0-559">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-559">Boolean</span></span>|<span data-ttu-id="0d4a0-560">Indica si se impide o no que el usuario tome capturas de pantalla.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-560">Indicates whether or not to block the user from taking Screenshots.</span></span>|
|<span data-ttu-id="0d4a0-561">siriBlocked</span><span class="sxs-lookup"><span data-stu-id="0d4a0-561">siriBlocked</span></span>|<span data-ttu-id="0d4a0-562">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-562">Boolean</span></span>|<span data-ttu-id="0d4a0-563">Indica si se va a impedir que el usuario use Siri.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-563">Indicates whether or not to block the user from using Siri.</span></span>|
|<span data-ttu-id="0d4a0-564">siriBlockedWhenLocked</span><span class="sxs-lookup"><span data-stu-id="0d4a0-564">siriBlockedWhenLocked</span></span>|<span data-ttu-id="0d4a0-565">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-565">Boolean</span></span>|<span data-ttu-id="0d4a0-566">Indica si se va a impedir que el usuario use Siri cuando está bloqueado.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-566">Indicates whether or not to block the user from using Siri when locked.</span></span>|
|<span data-ttu-id="0d4a0-567">siriBlockUserGeneratedContent</span><span class="sxs-lookup"><span data-stu-id="0d4a0-567">siriBlockUserGeneratedContent</span></span>|<span data-ttu-id="0d4a0-568">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-568">Boolean</span></span>|<span data-ttu-id="0d4a0-569">Indica si se va a impedir que Siri haga consultas de contenido generado por el usuario cuando se usa en un dispositivo supervisado.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-569">Indicates whether or not to block Siri from querying user-generated content when used on a supervised device.</span></span>|
|<span data-ttu-id="0d4a0-570">siriRequireProfanityFilter</span><span class="sxs-lookup"><span data-stu-id="0d4a0-570">siriRequireProfanityFilter</span></span>|<span data-ttu-id="0d4a0-571">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-571">Boolean</span></span>|<span data-ttu-id="0d4a0-572">Indica si se va a evitar que Siri dicte o hable con lenguaje irreverente en un dispositivo supervisado.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-572">Indicates whether or not to prevent Siri from dictating, or speaking profane language on supervised device.</span></span>|
|<span data-ttu-id="0d4a0-573">spotlightBlockInternetResults</span><span class="sxs-lookup"><span data-stu-id="0d4a0-573">spotlightBlockInternetResults</span></span>|<span data-ttu-id="0d4a0-574">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-574">Boolean</span></span>|<span data-ttu-id="0d4a0-575">Indica si se va a impedir que la búsqueda Spotlight devuelva resultados de Internet en un dispositivo supervisado.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-575">Indicates whether or not to block Spotlight search from returning internet results on supervised device.</span></span>|
|<span data-ttu-id="0d4a0-576">voiceDialingBlocked</span><span class="sxs-lookup"><span data-stu-id="0d4a0-576">voiceDialingBlocked</span></span>|<span data-ttu-id="0d4a0-577">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-577">Boolean</span></span>|<span data-ttu-id="0d4a0-578">Indica si se va a bloquear la marcación por voz.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-578">Indicates whether or not to block voice dialing.</span></span>|
|<span data-ttu-id="0d4a0-579">wallpaperBlockModification</span><span class="sxs-lookup"><span data-stu-id="0d4a0-579">wallpaperBlockModification</span></span>|<span data-ttu-id="0d4a0-580">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-580">Boolean</span></span>|<span data-ttu-id="0d4a0-581">Indica si se va permitir modificar el fondo de pantalla en un dispositivo supervisado (iOS 9.0 o posterior).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-581">Indicates whether or not to allow wallpaper modification on supervised device (iOS 9.0 and later) .</span></span>|
|<span data-ttu-id="0d4a0-582">wiFiConnectOnlyToConfiguredNetworks</span><span class="sxs-lookup"><span data-stu-id="0d4a0-582">wiFiConnectOnlyToConfiguredNetworks</span></span>|<span data-ttu-id="0d4a0-583">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-583">Boolean</span></span>|<span data-ttu-id="0d4a0-584">Indica si se va a forzar al dispositivo para que use solo redes Wi-Fi de perfiles de configuración cuando el dispositivo está en modo supervisado.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-584">Indicates whether or not to force the device to use only Wi-Fi networks from configuration profiles when the device is in supervised mode.</span></span>|
|<span data-ttu-id="0d4a0-585">classroomForceRequestPermissionToLeaveClasses</span><span class="sxs-lookup"><span data-stu-id="0d4a0-585">classroomForceRequestPermissionToLeaveClasses</span></span>|<span data-ttu-id="0d4a0-586">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-586">Boolean</span></span>|<span data-ttu-id="0d4a0-587">Indica si un estudiante inscrito en un curso de no administrado a través de aula solicitará permiso del profesor al intentar deje el curso (iOS 11.3 y versiones posteriores).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-587">Indicates whether a student enrolled in an unmanaged course via Classroom will request permission from the teacher when attempting to leave the course (iOS 11.3 and later).</span></span>|
|<span data-ttu-id="0d4a0-588">keychainBlockCloudSync</span><span class="sxs-lookup"><span data-stu-id="0d4a0-588">keychainBlockCloudSync</span></span>|<span data-ttu-id="0d4a0-589">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-589">Boolean</span></span>|<span data-ttu-id="0d4a0-590">Indica si se bloquea iCloud llaves sincronización.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-590">Indicates whether or not iCloud keychain synchronization is blocked.</span></span>|
|<span data-ttu-id="0d4a0-591">pkiBlockOTAUpdates</span><span class="sxs-lookup"><span data-stu-id="0d4a0-591">pkiBlockOTAUpdates</span></span>|<span data-ttu-id="0d4a0-592">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-592">Boolean</span></span>|<span data-ttu-id="0d4a0-593">Indica si está o no están bloqueadas por aire actualizaciones PKI.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-593">Indicates whether or not over-the-air PKI updates are blocked.</span></span> <span data-ttu-id="0d4a0-594">Si se establece esta restricción a false no deshabilitar las comprobaciones de CRL y OCSP (iOS 7.0 y versiones posteriores).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-594">Setting this restriction to false does not disable CRL and OCSP checks (iOS 7.0 and later).</span></span>|
|<span data-ttu-id="0d4a0-595">privacyForceLimitAdTracking</span><span class="sxs-lookup"><span data-stu-id="0d4a0-595">privacyForceLimitAdTracking</span></span>|<span data-ttu-id="0d4a0-596">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-596">Boolean</span></span>|<span data-ttu-id="0d4a0-597">Indica si el seguimiento de anuncios está limitado. (iOS 7.0 y versiones posteriores).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-597">Indicates if ad tracking is limited.(iOS 7.0 and later).</span></span>|
|<span data-ttu-id="0d4a0-598">enterpriseBookBlockBackup</span><span class="sxs-lookup"><span data-stu-id="0d4a0-598">enterpriseBookBlockBackup</span></span>|<span data-ttu-id="0d4a0-599">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-599">Boolean</span></span>|<span data-ttu-id="0d4a0-600">Indica si Enterprise book copia de seguridad está bloqueado.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-600">Indicates whether or not Enterprise book back up is blocked.</span></span>|
|<span data-ttu-id="0d4a0-601">enterpriseBookBlockMetadataSync</span><span class="sxs-lookup"><span data-stu-id="0d4a0-601">enterpriseBookBlockMetadataSync</span></span>|<span data-ttu-id="0d4a0-602">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-602">Boolean</span></span>|<span data-ttu-id="0d4a0-603">Indica si se bloquea en Enterprise libreta de direcciones, notas y resalta la sincronización.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-603">Indicates whether or not Enterprise book notes and highlights sync is blocked.</span></span>|
|<span data-ttu-id="0d4a0-604">airPrintBlocked</span><span class="sxs-lookup"><span data-stu-id="0d4a0-604">airPrintBlocked</span></span>|<span data-ttu-id="0d4a0-605">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-605">Boolean</span></span>|<span data-ttu-id="0d4a0-606">Indica si está o no AirPrint bloqueados (iOS 11.0 y versiones posteriores).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-606">Indicates whether or not AirPrint is blocked (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="0d4a0-607">airPrintBlockCredentialsStorage</span><span class="sxs-lookup"><span data-stu-id="0d4a0-607">airPrintBlockCredentialsStorage</span></span>|<span data-ttu-id="0d4a0-608">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-608">Boolean</span></span>|<span data-ttu-id="0d4a0-609">Indica si está o no llaves almacenamiento de nombre de usuario y la contraseña de Airprint bloqueados (iOS 11.0 y versiones posteriores).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-609">Indicates whether or not keychain storage of username and password for Airprint is blocked (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="0d4a0-610">airPrintForceTrustedTLS</span><span class="sxs-lookup"><span data-stu-id="0d4a0-610">airPrintForceTrustedTLS</span></span>|<span data-ttu-id="0d4a0-611">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-611">Boolean</span></span>|<span data-ttu-id="0d4a0-612">Indica si los certificados de confianza son necesarios para la comunicación de impresión de TLS (iOS 11.0 y versiones posteriores).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-612">Indicates if trusted certificates are required for TLS printing communication (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="0d4a0-613">airPrintBlockiBeaconDiscovery</span><span class="sxs-lookup"><span data-stu-id="0d4a0-613">airPrintBlockiBeaconDiscovery</span></span>|<span data-ttu-id="0d4a0-614">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-614">Boolean</span></span>|<span data-ttu-id="0d4a0-615">Indica si se bloquea en iBeacon detección de impresoras AirPrint.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-615">Indicates whether or not iBeacon discovery of AirPrint printers is blocked.</span></span> <span data-ttu-id="0d4a0-616">Esto evita falsas balizas de AirPrint Bluetooth de suplantación de identidad para el tráfico de red (iOS 11.0 y versiones posteriores).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-616">This prevents spurious AirPrint Bluetooth beacons from phishing for network traffic (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="0d4a0-617">blockSystemAppRemoval</span><span class="sxs-lookup"><span data-stu-id="0d4a0-617">blockSystemAppRemoval</span></span>|<span data-ttu-id="0d4a0-618">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-618">Boolean</span></span>|<span data-ttu-id="0d4a0-619">Indica si la eliminación de las aplicaciones del sistema desde el dispositivo está bloqueada en un dispositivo supervisado (iOS 11.0 y versiones posteriores).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-619">Indicates whether or not the removal of system apps from the device is blocked on a supervised device (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="0d4a0-620">vpnBlockCreation</span><span class="sxs-lookup"><span data-stu-id="0d4a0-620">vpnBlockCreation</span></span>|<span data-ttu-id="0d4a0-621">Boolean</span><span class="sxs-lookup"><span data-stu-id="0d4a0-621">Boolean</span></span>|<span data-ttu-id="0d4a0-622">Indica si está o no la creación de configuraciones de VPN bloqueados (iOS 11.0 y versiones posteriores).</span><span class="sxs-lookup"><span data-stu-id="0d4a0-622">Indicates whether or not the creation of VPN configurations is blocked (iOS 11.0 and later).</span></span>|



## <a name="response"></a><span data-ttu-id="0d4a0-623">Respuesta</span><span class="sxs-lookup"><span data-stu-id="0d4a0-623">Response</span></span>
<span data-ttu-id="0d4a0-624">Si se ejecuta correctamente, este método devuelve un código de respuesta `201 Created` y un objeto [iosGeneralDeviceConfiguration](../resources/intune-deviceconfig-iosgeneraldeviceconfiguration.md) en el cuerpo de la respuesta.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-624">If successful, this method returns a `201 Created` response code and a [iosGeneralDeviceConfiguration](../resources/intune-deviceconfig-iosgeneraldeviceconfiguration.md) object in the response body.</span></span>

## <a name="example"></a><span data-ttu-id="0d4a0-625">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="0d4a0-625">Example</span></span>
### <a name="request"></a><span data-ttu-id="0d4a0-626">Solicitud</span><span class="sxs-lookup"><span data-stu-id="0d4a0-626">Request</span></span>
<span data-ttu-id="0d4a0-627">Aquí tiene un ejemplo de la solicitud.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-627">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="0d4a0-628">Respuesta</span><span class="sxs-lookup"><span data-stu-id="0d4a0-628">Response</span></span>
<span data-ttu-id="0d4a0-p132">Aquí tiene un ejemplo de la respuesta. Nota: Puede que el objeto de respuesta que aparece aquí se trunque para abreviar. Todas las propiedades se devolverán de una llamada real.</span><span class="sxs-lookup"><span data-stu-id="0d4a0-p132">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http

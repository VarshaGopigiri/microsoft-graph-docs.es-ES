...
---
# <a name="get-privilegedrole"></a>Obtener privilegedRole

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Recuperar las propiedades y relaciones del objeto [privilegedRole](../resources/privilegedrole.md) . 
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [privilegedRole](../resources/privilegedrole.md) de respuesta en el cuerpo de la respuesta.

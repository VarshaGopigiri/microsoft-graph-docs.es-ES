...
Obtiene el número de páginas vistas en todos los sitios.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[sharePointSiteUsagePages](../resources/sharepointsiteusagepages.md)** en el cuerpo de la respuesta.

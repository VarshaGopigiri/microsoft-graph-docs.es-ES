...
Leer las propiedades y las relaciones del objeto [windowsCertificateProfileBase](../resources/intune-deviceconfig-windowscertificateprofilebase.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [windowsCertificateProfileBase](../resources/intune-deviceconfig-windowscertificateprofilebase.md) de respuesta en el cuerpo de la respuesta.

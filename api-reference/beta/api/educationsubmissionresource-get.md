...
Recupera las propiedades de un recurso específico asociado con el envío. Este recurso se encuentra en la lista de recursos de "trabajo" y se debe considerar trabajo en proceso por un estudiante. Este recurso se empaqueta con un puntero al recurso de asignación posible si se copió desde la asignación.

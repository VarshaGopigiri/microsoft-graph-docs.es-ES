...
Recuperar las propiedades y relaciones del objeto serviceprincipal.
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [servicePrincipal](../resources/serviceprincipal.md) de respuesta en el cuerpo de la respuesta.

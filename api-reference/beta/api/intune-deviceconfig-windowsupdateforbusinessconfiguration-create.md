...
|qualityUpdatesPauseStartDateTime|Cadena|Datetime de inicio de pausa de actualizaciones de calidad|
|featureUpdatesPauseStartDateTime|Cadena|Característica Actualizaciones pausar iniciar datetime|

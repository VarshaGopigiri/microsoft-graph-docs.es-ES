...
ms.locfileid: "27940312"
---
# <a name="list-macoswificonfigurations"></a><span data-ttu-id="6884e-103">Lista macOSWiFiConfigurations</span><span class="sxs-lookup"><span data-stu-id="6884e-103">List macOSWiFiConfigurations</span></span>
...
<span data-ttu-id="6884e-107">Propiedades de la lista y relaciones de los objetos [macOSWiFiConfiguration](../resources/intune-deviceconfig-macoswificonfiguration.md) .</span><span class="sxs-lookup"><span data-stu-id="6884e-107">List properties and relationships of the [macOSWiFiConfiguration](../resources/intune-deviceconfig-macoswificonfiguration.md) objects.</span></span>
...
|:---|:---|
|<span data-ttu-id="6884e-113">Delegado (cuenta profesional o educativa)</span><span class="sxs-lookup"><span data-stu-id="6884e-113">Delegated (work or school account)</span></span>|<span data-ttu-id="6884e-114">DeviceManagementConfiguration.ReadWrite.All, DeviceManagementConfiguration.Read.All</span><span class="sxs-lookup"><span data-stu-id="6884e-114">DeviceManagementConfiguration.ReadWrite.All, DeviceManagementConfiguration.Read.All</span></span>|
...
|<span data-ttu-id="6884e-125">Accept</span><span class="sxs-lookup"><span data-stu-id="6884e-125">Accept</span></span>|<span data-ttu-id="6884e-126">application/json</span><span class="sxs-lookup"><span data-stu-id="6884e-126">application/json</span></span>|
...
<span data-ttu-id="6884e-128">No proporcione un cuerpo de solicitud para este método.</span><span class="sxs-lookup"><span data-stu-id="6884e-128">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="6884e-129">Respuesta</span><span class="sxs-lookup"><span data-stu-id="6884e-129">Response</span></span>
<span data-ttu-id="6884e-130">Si tiene éxito, este método devuelve una `200 OK` código de respuesta y una colección de objetos de [macOSWiFiConfiguration](../resources/intune-deviceconfig-macoswificonfiguration.md) en el cuerpo de la respuesta.</span><span class="sxs-lookup"><span data-stu-id="6884e-130">If successful, this method returns a `200 OK` response code and a collection of [macOSWiFiConfiguration](../resources/intune-deviceconfig-macoswificonfiguration.md) objects in the response body.</span></span>

## <a name="example"></a><span data-ttu-id="6884e-131">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="6884e-131">Example</span></span>
### <a name="request"></a><span data-ttu-id="6884e-132">Solicitud</span><span class="sxs-lookup"><span data-stu-id="6884e-132">Request</span></span>
<span data-ttu-id="6884e-133">Aquí tiene un ejemplo de la solicitud.</span><span class="sxs-lookup"><span data-stu-id="6884e-133">Here is an example of the request.</span></span>
``` http
GET https://graph.microsoft.com/beta/deviceManagement/deviceConfigurations
```

### <a name="response"></a><span data-ttu-id="6884e-134">Respuesta</span><span class="sxs-lookup"><span data-stu-id="6884e-134">Response</span></span>

...
---
# <a name="create-privilegedapproval"></a>Crear privilegedApproval

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Utilice esta API para crear un nuevo privilegedApproval.
...
En el cuerpo de la solicitud, proporcionar una representación JSON del objeto [privilegedApproval](../resources/privilegedapproval.md) .

## <a name="response"></a>Respuesta

Si tiene éxito, este método devuelve `201 Created` objeto de código y [privilegedApproval](../resources/privilegedapproval.md) de respuesta en el cuerpo de la respuesta.

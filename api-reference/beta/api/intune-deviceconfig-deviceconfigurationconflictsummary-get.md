...
Leer las propiedades y las relaciones del objeto [deviceConfigurationConflictSummary](../resources/intune-deviceconfig-deviceconfigurationconflictsummary.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [deviceConfigurationConflictSummary](../resources/intune-deviceconfig-deviceconfigurationconflictsummary.md) de respuesta en el cuerpo de la respuesta.

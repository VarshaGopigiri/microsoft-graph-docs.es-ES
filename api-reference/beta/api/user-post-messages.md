...
Al crear el borrador en la misma llamada **POST** , se puede:
...
En el cuerpo de la solicitud, proporcionar una representación JSON del objeto de [mensaje](../resources/message.md) .
...
Dado que el recurso **message** admite [extensiones](/graph/extensibility-overview), puede utilizar la operación `POST` y agregar propiedades personalizadas con sus propios datos al mensaje al crearla.

## <a name="response"></a>Respuesta

Si tiene éxito, este método devuelve una `201 Created` código de respuesta y un objeto de [mensaje](../resources/message.md) en el cuerpo de la respuesta.

## <a name="example"></a>Ejemplo
##### <a name="request-1"></a>Solicitud 1
Este es un ejemplo de la solicitud para crear un borrador de un nuevo mensaje.
<!-- {
  "blockType": "request",
...
En el ejemplo siguiente se muestra un correo electrónico de borrador por Randi Welch a Samantha Booth. El mensaje también incluye una mención de otro usuario, Dana Swope.
...
En el ejemplo siguiente se agrega un par de encabezados de mensaje de Internet del cliente al crear el borrador del mensaje.
<!-- {
  "blockType": "request",
...
Aquí tiene un ejemplo de la respuesta. Nota: No se devuelven los encabezados de mensaje de Internet de forma predeterminada en una respuesta POST. También se puede truncar el objeto de respuesta que se muestra aquí por razones de brevedad. Todas las propiedades se devolverán desde una llamada real.
<!-- {
  "blockType": "response",
  "name": "create_message_with_headers_from_user",
  "truncated": true,

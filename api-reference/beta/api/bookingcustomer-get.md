...
Obtener las propiedades y relaciones de un objeto [bookingCustomer](../resources/bookingcustomer.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [bookingCustomer](../resources/bookingcustomer.md) de respuesta en el cuerpo de la respuesta.

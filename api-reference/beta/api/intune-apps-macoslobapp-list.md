...
Propiedades de la lista y relaciones de los objetos [macOSLobApp](../resources/intune-apps-macoslobapp.md) .
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y una colección de objetos de [macOSLobApp](../resources/intune-apps-macoslobapp.md) en el cuerpo de la respuesta.

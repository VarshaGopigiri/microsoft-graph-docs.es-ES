...
Leer las propiedades y las relaciones del objeto [deviceManagementScript](../resources/intune-devices-devicemanagementscript.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [deviceManagementScript](../resources/intune-devices-devicemanagementscript.md) de respuesta en el cuerpo de la respuesta.

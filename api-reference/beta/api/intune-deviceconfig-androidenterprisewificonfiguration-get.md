...
Leer las propiedades y las relaciones del objeto [androidEnterpriseWiFiConfiguration](../resources/intune-deviceconfig-androidenterprisewificonfiguration.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [androidEnterpriseWiFiConfiguration](../resources/intune-deviceconfig-androidenterprisewificonfiguration.md) de respuesta en el cuerpo de la respuesta.

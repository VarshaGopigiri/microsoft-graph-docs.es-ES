...
Se trata de una acción de servicio, lo que significa que no admite la paginación.  La API devuelve objetos eliminados hasta 1.000 que pertenecen al usuario, ordenado por identificador.  Debe el usuario propietario de 1.000 o más elimina los objetos, la API devuelve nothing.

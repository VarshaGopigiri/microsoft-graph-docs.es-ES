...
|serviceId|Cadena|El identificador de la [bookingService](../resources/bookingservice.md) asociadas con esta cita.|
...
|serviceNotes|Cadena|Notas de un [bookingStaffMember](../resources/bookingstaffmember.md). El valor de esta propiedad está disponible sólo cuando se lee este **bookingAppointment** por su identificador.|

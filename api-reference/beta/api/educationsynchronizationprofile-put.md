...
Actualizar las propiedades de una existente de datos school [perfil de sincronización](../resources/educationsynchronizationprofile.md) en el inquilino.
...
En el cuerpo de la solicitud, proporcionar una representación JSON del objeto [synchronizationProfile](../resources/educationsynchronizationprofile.md) .

## <a name="response"></a>Respuesta
Si tiene éxito, este método devuelve una `202, Accepted` código de respuesta y un objeto [synchronizationProfile](../resources/educationsynchronizationprofile.md) en el cuerpo de la respuesta.

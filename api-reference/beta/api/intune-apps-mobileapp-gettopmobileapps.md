...
---
# <a name="gettopmobileapps-function"></a>getTopMobileApps (función)
...
|:---|:---|:---|
|status|String|Todavía no documentado|
|count|Int64|Todavía no documentado|



## <a name="response"></a>Respuesta
Si tiene éxito, esta función devuelve una `200 OK` código de respuesta y una colección de [mobileApp](../resources/intune-apps-mobileapp.md) en el cuerpo de la respuesta.

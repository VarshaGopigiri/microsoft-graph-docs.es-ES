...
Leer las propiedades y las relaciones del objeto [windowsProtectionState](../resources/intune-devices-windowsprotectionstate.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [windowsProtectionState](../resources/intune-devices-windowsprotectionstate.md) de respuesta en el cuerpo de la respuesta.

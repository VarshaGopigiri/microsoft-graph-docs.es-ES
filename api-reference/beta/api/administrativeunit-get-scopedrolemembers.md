...
Recuperar un recurso específico [scopedRoleMembership](../resources/scopedrolemembership.md) .
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y el objeto solicitado [scopedRoleMembership](../resources/scopedrolemembership.md) en el cuerpo de la respuesta.

...
Recuperar una lista de objetos de [administrativeUnit](../resources/administrativeunit.md) .
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y la colección de objetos de [administrativeUnit](../resources/administrativeunit.md) en el cuerpo de la respuesta.

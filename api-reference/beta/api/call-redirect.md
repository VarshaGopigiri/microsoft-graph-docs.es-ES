...
Redirigir una llamada entrante.
...
|maskCallee|Boolean|Indica si se va a enmascarar el destinatario de la llamada.|
|maskCaller|Boolean|Indica si se va a enmascarar el autor de la llamada.|
...
### <a name="redirect-a-call"></a>Redirigir una llamada
...
### <a name="forward-a-call"></a>Transferir una llamada
...
##### <a name="notification---redirecting"></a>Notificación - redirigir

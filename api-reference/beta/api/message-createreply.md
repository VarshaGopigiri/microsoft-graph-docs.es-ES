...
Cree un borrador de un mensaje de respuesta para incluir un comentario o actualizar las propiedades de mensaje todo en una sola llamada **createReply** . A continuación, puede [Actualizar](../api/message-update.md) o [Enviar](../api/message-send.md) el borrador.
...
- Si el **origen** se especifica en el mensaje original, por el formato de mensaje de Internet ([RFC 2822](https://www.rfc-editor.org/info/rfc2822)), debe enviar la respuesta a los destinatarios en **replyTo**y no los destinatarios **desde**. 
...
En el ejemplo siguiente se crea un borrador de respuesta, se agrega un comentario y un destinatario en el cuerpo de la solicitud.

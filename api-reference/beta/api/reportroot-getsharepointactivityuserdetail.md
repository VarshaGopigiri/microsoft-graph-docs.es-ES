...
Obtiene información sobre la actividad de SharePoint por usuario.
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[sharePointActivityUserDetail](../resources/sharepointactivityuserdetail.md)** en el cuerpo de la respuesta.

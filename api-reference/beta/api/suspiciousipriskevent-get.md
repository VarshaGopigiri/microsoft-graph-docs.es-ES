...
---
# <a name="get-suspiciousipriskevent"></a>Obtener suspiciousIpRiskEvent

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Recuperar las propiedades y relaciones de un objeto suspiciousipriskevent.
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [suspiciousIpRiskEvent](../resources/suspiciousipriskevent.md) de respuesta en el cuerpo de la respuesta.

...
Recuperar las propiedades y relaciones de un objeto **participante** .
...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto de [participante](../resources/participant.md) en el cuerpo de la respuesta.

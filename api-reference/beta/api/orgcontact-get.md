...
---
# <a name="get-orgcontact"></a>Obtener orgContact

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Recuperar las propiedades y relaciones del objeto orgcontact.
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [orgContact](../resources/orgcontact.md) de respuesta en el cuerpo de la respuesta.

...
---
# <a name="application-calculate"></a>Aplicación: calcular
...
|:---------------|:--------|:----------|
|calculationType|string|Especifica el tipo de cálculo que desea utilizar.  Los valores posibles son: `Recalculate`, `Full` y `FullRebuild`.|

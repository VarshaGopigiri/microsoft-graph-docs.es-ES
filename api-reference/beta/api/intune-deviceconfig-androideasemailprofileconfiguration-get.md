...
Leer las propiedades y las relaciones del objeto [androidEasEmailProfileConfiguration](../resources/intune-deviceconfig-androideasemailprofileconfiguration.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [androidEasEmailProfileConfiguration](../resources/intune-deviceconfig-androideasemailprofileconfiguration.md) de respuesta en el cuerpo de la respuesta.

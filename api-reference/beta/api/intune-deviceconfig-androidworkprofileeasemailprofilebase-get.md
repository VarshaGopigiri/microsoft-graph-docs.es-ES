...
Leer las propiedades y las relaciones del objeto [androidWorkProfileEasEmailProfileBase](../resources/intune-deviceconfig-androidworkprofileeasemailprofilebase.md) .
...
Si tiene éxito, este método devuelve una `200 OK` objeto de código y [androidWorkProfileEasEmailProfileBase](../resources/intune-deviceconfig-androidworkprofileeasemailprofilebase.md) de respuesta en el cuerpo de la respuesta.

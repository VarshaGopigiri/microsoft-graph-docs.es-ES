...
---
# <a name="get-synchronizationjob"></a>Obtener synchronizationJob

> **Importante:** Las API de la versión /beta de Microsoft Graph son una versión preliminar y están sujetas a cambios. No se admite el uso de estas API en aplicaciones de producción.

Recuperar el trabajo de sincronización existente y sus propiedades.
...
Si se realiza correctamente, devuelve un `200 OK` respuesta con un [synchronizationJob](../resources/synchronization-synchronizationjob.md) en el cuerpo de la respuesta.

...
Si tiene éxito, este método devuelve una `200 OK` código de respuesta y un objeto **[yammerActivityUserDetail](../resources/yammeractivityuserdetail.md)** en el cuerpo de la respuesta.

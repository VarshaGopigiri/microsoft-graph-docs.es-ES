...
Contiene propiedades y propiedades heredadas para Android para el trabajo (AFW) de aplicaciones.
...
|:---|:---|:---|
|[Lista androidForWorkApps](../api/intune-apps-androidforworkapp-list.md)|colección de [androidForWorkApp](../resources/intune-apps-androidforworkapp.md)|Propiedades de la lista y relaciones de los objetos [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) .|
|[Obtener androidForWorkApp](../api/intune-apps-androidforworkapp-get.md)|[androidForWorkApp](../resources/intune-apps-androidforworkapp.md)|Leer las propiedades y las relaciones del objeto [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) .|
|[Crear androidForWorkApp](../api/intune-apps-androidforworkapp-create.md)|[androidForWorkApp](../resources/intune-apps-androidforworkapp.md)|Crear un nuevo objeto [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) .|
|[Eliminar androidForWorkApp](../api/intune-apps-androidforworkapp-delete.md)|Ninguno|Elimina un [androidForWorkApp](../resources/intune-apps-androidforworkapp.md).|
|[Actualizar androidForWorkApp](../api/intune-apps-androidforworkapp-update.md)|[androidForWorkApp](../resources/intune-apps-androidforworkapp.md)|Actualizar las propiedades de un objeto [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) .|

...
| groupDisplayName                  | String  | El nombre para mostrar del grupo.           |
| isDeleted                         | Booleano | Si este usuario se ha eliminado o suave eliminados. |
| ownerPrincipalName                | String  | El nombre de entidad de seguridad del propietario de grupo.          |
...
| groupType                         | String  | El tipo de grupo. Los valores posibles son: **público** o **privado**. |

...
Perfil de certificado para Android base.
...
|:---|:---|:---|
|[Lista androidCertificateProfileBases](../api/intune-deviceconfig-androidcertificateprofilebase-list.md)|colección de [androidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md)|Propiedades de la lista y relaciones de los objetos [androidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md) .|
|[Obtener androidCertificateProfileBase](../api/intune-deviceconfig-androidcertificateprofilebase-get.md)|[androidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md)|Leer las propiedades y las relaciones del objeto [androidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md) .|
...
|rootCertificate|[androidTrustedRootCertificate](../resources/intune-deviceconfig-androidtrustedrootcertificate.md)|Certificado raíz de confianza.|

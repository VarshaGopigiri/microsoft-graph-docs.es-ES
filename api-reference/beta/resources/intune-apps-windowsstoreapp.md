...
Contiene propiedades y propiedades heredadas para aplicaciones de la tienda de Windows.
...
|:---|:---|:---|
|[Lista windowsStoreApps](../api/intune-apps-windowsstoreapp-list.md)|colección de [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md)|Propiedades de la lista y relaciones de los objetos [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) .|
|[Obtener windowsStoreApp](../api/intune-apps-windowsstoreapp-get.md)|[windowsStoreApp](../resources/intune-apps-windowsstoreapp.md)|Leer las propiedades y las relaciones del objeto [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) .|
|[Crear windowsStoreApp](../api/intune-apps-windowsstoreapp-create.md)|[windowsStoreApp](../resources/intune-apps-windowsstoreapp.md)|Crear un nuevo objeto [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) .|
|[Eliminar windowsStoreApp](../api/intune-apps-windowsstoreapp-delete.md)|Ninguno|Elimina un [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md).|
|[Actualizar windowsStoreApp](../api/intune-apps-windowsstoreapp-update.md)|[windowsStoreApp](../resources/intune-apps-windowsstoreapp.md)|Actualizar las propiedades de un objeto [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) .|
...
|appStoreUrl|String|URL de la tienda de aplicación de Windows.|

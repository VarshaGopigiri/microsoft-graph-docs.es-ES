...
|committedContainedApps|colección de [mobileContainedApp](../resources/intune-apps-mobilecontainedapp.md)|La colección de aplicaciones contenidas en el mobileAppContent de una aplicación de windowsUniversalAppX confirmado.|

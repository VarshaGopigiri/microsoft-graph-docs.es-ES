...
| Delegar a otro usuario para enviar mensajes en nombre del propietario del buzón | [message](../resources/message.md) | Establecer las propiedades **de** y **remitente** en un [mensaje](../resources/message.md) |
...
| Obtener las opciones de idioma y zona horaria de un usuario | [localeInfo](localeinfo.md), <br> [timeZoneInformation](timezoneinformation.md) | [supportedLanguages](../api/outlookuser-supportedlanguages.md), <br> [supportedTimeZones](../api/outlookuser-supportedtimezones.md) |
...
| Avisar al usuario si se menciona en otros mensajes (vista previa) | [Mencione (vista previa)](../resources/mention.md) | [Obtener detalles de @ menciones en un mensaje](../api/message-get.md#request-2) |
| Cancelación de suscripción de usuario desde una lista de distribución de correo electrónico (vista previa) | [mensaje (vista previa)](../resources/message.md) | [Unsubscribe](../api/message-unsubscribe.md) |
...
| Clasificar los mensajes | [outlookCategory (vista previa)](../resources/outlookcategory.md) | [Métodos de outlookCategory](../resources/outlookcategory.md#methods) |
| Uso de reglas de bandeja de entrada para automatizar acciones como la transferencia de mensajes entrantes específicos | [messageRule (vista previa)](../resources/messagerule.md) | [Métodos de messageRule](../resources/messagerule.md#methods) |
| Obtener encabezados de mensajes de Internet de un mensaje | [mensaje (vista previa)](../resources/message.md) | [Obtener la propiedad **internetMessageHeaders** de un mensaje](../api/message-get.md#request-4). |
...
| Agregar datos de aplicación personalizadas como encabezados de mensaje de Internet de un mensaje | [message](../resources/message.md) | Agregar datos personalizados a la colección **internetMessageHeaders** del mensaje. |

...
Contiene propiedades y propiedades heredadas para aplicaciones de la tienda administrados Android.
...
|:---|:---|:---|
|[Lista androidManagedStoreApps](../api/intune-apps-androidmanagedstoreapp-list.md)|colección de [androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md)|Propiedades de la lista y relaciones de los objetos [androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md) .|
|[Obtener androidManagedStoreApp](../api/intune-apps-androidmanagedstoreapp-get.md)|[androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md)|Leer las propiedades y las relaciones del objeto [androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md) .|
|[Crear androidManagedStoreApp](../api/intune-apps-androidmanagedstoreapp-create.md)|[androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md)|Crear un nuevo objeto [androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md) .|
|[Eliminar androidManagedStoreApp](../api/intune-apps-androidmanagedstoreapp-delete.md)|Ninguno|Elimina un [androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md).|
|[Actualizar androidManagedStoreApp](../api/intune-apps-androidmanagedstoreapp-update.md)|[androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md)|Actualizar las propiedades de un objeto [androidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md) .|
...
|appIdentifier|Cadena|Nombre de la identidad.|
|usedLicenseCount|Int32|Número de licencias VPP en uso.|
|totalLicenseCount|Int32|Número total de licencias VPP.|
|appStoreUrl|Cadena|Reproducir para la dirección URL de la aplicación de almacenamiento de trabajo.|

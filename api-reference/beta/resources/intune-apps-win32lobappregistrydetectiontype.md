...
|doesNotExist|2|La clave del registro especificada o el valor no existe.|
|string|3|Tipo de valor de cadena.|
|integer|4|Tipo de valor entero.|
|version|5|Tipo de valor de la versión.|

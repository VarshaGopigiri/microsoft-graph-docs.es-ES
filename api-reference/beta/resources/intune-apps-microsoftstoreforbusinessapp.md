...
|containedApps|colección de [mobileContainedApp](../resources/intune-apps-mobilecontainedapp.md)|La colección de aplicaciones de contenido en una mobileApp que actúa como un paquete.|

...
Base para los perfiles de Android para EAS correo electrónico del trabajo
...
|:---|:---|:---|
|[Lista androidForWorkEasEmailProfileBases](../api/intune-deviceconfig-androidforworkeasemailprofilebase-list.md)|colección de [androidForWorkEasEmailProfileBase](../resources/intune-deviceconfig-androidforworkeasemailprofilebase.md)|Propiedades de la lista y relaciones de los objetos [androidForWorkEasEmailProfileBase](../resources/intune-deviceconfig-androidforworkeasemailprofilebase.md) .|
|[Obtener androidForWorkEasEmailProfileBase](../api/intune-deviceconfig-androidforworkeasemailprofilebase-get.md)|[androidForWorkEasEmailProfileBase](../resources/intune-deviceconfig-androidforworkeasemailprofilebase.md)|Leer las propiedades y las relaciones del objeto [androidForWorkEasEmailProfileBase](../resources/intune-deviceconfig-androidforworkeasemailprofilebase.md) .|
...
|hostName|String|Ubicación de Exchange (URL) que la aplicación de correo se conecta a.|
...
|identityCertificate|[androidForWorkCertificateProfileBase](../resources/intune-deviceconfig-androidforworkcertificateprofilebase.md)|Certificado de identidad.|

...
|:---------------|:--------|:----------|
|availabilityView |String |Representa una vista combinada de disponibilidad de todos los elementos en `scheduleItems`. La vista se compone de intervalos de tiempo. Disponibilidad durante cada franja horaria se indica con: `0`= gratis, `1`= provisional, `2`= ocupado, `3`= fuera de la oficina, `4`= trabajar en otro lugar.|
...
|scheduleId |String |Una dirección SMTP del usuario, la lista de distribución o el recurso, que identifica una instancia de **scheduleInformation**. |

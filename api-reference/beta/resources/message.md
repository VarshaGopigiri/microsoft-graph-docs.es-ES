...
|bodyPreview|Cadena|Los primeros 255 caracteres del cuerpo del mensaje. Está en formato de texto. Si el mensaje contiene instancias de [mencionar](mention.md), esta propiedad contendrá una concatenación de estas menciones así como. |
...
|inferenceClassification|Cadena| La clasificación del mensaje para el usuario, basándose en la relevancia inferida o importancia, o en un reemplazo explícito. Los valores posibles son: `focused` y `other`.|
...
|internetMessageId | Cadena | El identificador de mensaje en el formato especificado por [RFC5322](https://www.ietf.org/rfc/rfc5322.txt). Actualizable sólo si **isDraft** es true.|

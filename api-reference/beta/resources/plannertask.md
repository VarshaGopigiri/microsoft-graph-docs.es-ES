...
|bucketId|String|Identificador de cubo al que pertenece la tarea. Debe estar en el plan de que la tarea se encuentra en el cubo. Es 28 caracteres de largo y entre mayúsculas y minúsculas. [Validación de formato](tasks-identifiers-disclaimer.md) se realiza en el servicio. |
...
|id|String|Solo lectura. Identificador de la tarea. Es 28 caracteres de largo y entre mayúsculas y minúsculas. [Validación de formato](tasks-identifiers-disclaimer.md) se realiza en el servicio.|

...
|:--------------------|:---------------------------------------|:----------|
|id                   |String                                  |El identificador de la roleSetting.|
...
|lastUpdatedBy        |String                                  |Solo lectura. El nombre para mostrar del administrador que actualizó por última vez el roleSetting.|

...
Contiene propiedades y propiedades heredadas para las aplicaciones de línea de negocio de Windows Phone XAP.
...
|:---|:---|:---|
|[Lista windowsPhoneXAPs](../api/intune-apps-windowsphonexap-list.md)|colección de [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)|Propiedades de la lista y relaciones de los objetos [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) .|
|[Obtener windowsPhoneXAP](../api/intune-apps-windowsphonexap-get.md)|[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)|Leer las propiedades y las relaciones del objeto [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) .|
|[Crear windowsPhoneXAP](../api/intune-apps-windowsphonexap-create.md)|[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)|Crear un nuevo objeto [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) .|
|[Eliminar windowsPhoneXAP](../api/intune-apps-windowsphonexap-delete.md)|Ninguno|Elimina un [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md).|
|[Actualizar windowsPhoneXAP](../api/intune-apps-windowsphonexap-update.md)|[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)|Actualizar las propiedades de un objeto [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) .|
...
|productIdentifier|Cadena|El identificador del producto.|

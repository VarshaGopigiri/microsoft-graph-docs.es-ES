...
|[Cancelar](../api/governanceroleassignmentrequest-cancel.md)|  |Cancelar una solicitud de asignación de roles pendiente.|
...
|roleAssignmentStartDateTime|DateTimeOffset |La hora de inicio para la asignación de roles. El tipo de marca de tiempo representa la información de fecha y hora con el formato ISO 8601 y está siempre en hora UTC. Por ejemplo, la medianoche UTC del 1 de enero de 2014 sería así: `'2014-01-01T00:00:00Z'`|
|roleAssignmentEndDateTime|DateTimeOffset   |La hora de finalización para la asignación de roles. El tipo de marca de tiempo representa la información de fecha y hora con el formato ISO 8601 y está siempre en hora UTC. Por ejemplo, la medianoche UTC del 1 de enero de 2014 sería así: `'2014-01-01T00:00:00Z'`|

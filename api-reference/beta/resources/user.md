...
|[Crear mensaje](../api/user-post-messages.md) |[Message](message.md)| Crear un mensaje de registro a la colección de los mensajes.|
...
|[Enumerar calendarView](../api/user-list-calendarview.md) |Colección [event](event.md)| Obtener una colección de objetos de evento.|
...
|[Enumerar registeredDevices](../api/user-list-registereddevices.md) |Colección [directoryObject](directoryobject.md)| Obtenga los dispositivos que están registrados para el usuario de la propiedad de navegación registeredDevices.|
|[Pertenencias de rol con ámbito de lista](../api/user-list-scopedrolememberof.md) |colección de [scopedRoleMembership](scopedrolemembership.md)| Pertenencia a grupos de la función con ámbito de Get unidades administrativas para este usuario.|
...
|[Lista agreementAcceptances](../api/user-list-agreementacceptances.md) | colección de [agreementAcceptance](agreementacceptance.md) | Obtener una lista de condiciones de uso de Estados de aceptación del usuario.|
...
|[findmeetingtimes](../api/user-findmeetingtimes.md)|[meetingTimeCandidate](meetingtimecandidate.md)|Buscar tiempo y ubicaciones para satisfacer en función de la disponibilidad de los asistentes, la ubicación o las restricciones de tiempo.|
|[findRoomLists](../api/user-findroomlists.md)|colección de [EmailAddress.MD](emailaddress.md) | Obtener las listas de salas definidas en un inquilino.|
|[findRooms](../api/user-findrooms.md)|colección de [EmailAddress.MD](emailaddress.md) | Obtenga todas las salas de reuniones en el inquilino del usuario o en una lista de salas específicas. |
|[getMailTips](../api/user-getmailtips.md)|colección de [sugerencias de correo electrónico](mailtips.md)|Devolver las sugerencias de correo electrónico de uno o más destinatarios como disponible para el usuario ha iniciado sesión. |
...
|[getMemberObjects](../api/user-getmemberobjects.md)|Colección string| Devolver todos los roles de Active directory, grupos y unidades administrativas que el usuario es un miembro de. La comprobación es transitiva. |
|[invalidateAllRefreshTokens](../api/user-invalidateallrefreshtokens.md)| Ninguno |Invalida sesión y la actualización de los tokens todos los del usuario emitidos a las aplicaciones, al restablecer la propiedad de usuario **refreshTokensValidFromDateTime** a la fecha y hora actual. Esto obliga al usuario a iniciar sesión en esas aplicaciones.|
...
|[Traducir identificadores de Outlook](../api/user-translateexchangeids.md) |colección de [tipo de recurso convertIdResult](convertidresult.md)| Traducir identificadores de recursos relacionados con Outlook entre formatos.|
...
|calendarGroups|colección de [calendarGroup](calendargroup.md)|Los grupos de calendario del usuario. Solo lectura. Admite valores NULL.|
|calendarView|Colección [event](event.md)|La vista Calendario del calendario. Solo lectura. Admite valores NULL.|
|calendars|[calendar](calendar.md) collection|Los calendarios del usuario. Solo lectura. Admite valores NULL.|
|contactFolders|colección de [contactFolder](contactfolder.md)|Las carpetas de contactos del usuario. Solo lectura. Admite valores NULL.|
|contactos|Colección [contact](contact.md)|Los contactos del usuario. Solo lectura. Admite valores NULL.|
...
|extensions|Colección de [extensiones](extension.md)|La colección de extensiones de open definidas para el usuario. Admite valores NULL.|
...
|conocimientos|colección de [conocimientos](insights.md)| Solo lectura. Admite valores NULL.|
|joinedGroups|Colección [group](group.md)| Solo lectura. Admite valores NULL.|
...
|memberOf|Colección [directoryObject](directoryobject.md)|Los grupos, las funciones de Active directory y unidades administrativas que el usuario es un miembro de. Solo lectura. Admite valores NULL.|
|joinedTeams|Colección [group](group.md)|El Teams Microsoft que el usuario es un miembro de. Solo lectura. Admite valores NULL.|
...
|Outlook|[outlookUser](outlookuser.md)| Servicios de Outlook selectivos disponibles para el usuario. Solo lectura. Admite valores NULL.|
...
|personas|colección de [persona](person.md)| Solo lectura. Las personas más relevantes para el usuario. La colección se ordena por su importancia para el usuario, que está determinado por el usuario comunicación, colaboración y las relaciones de negocios. Una persona es una suma de información a través de correo, contactos y las redes sociales.|
|photo|[profilePhoto](profilephoto.md)| La foto de perfil del usuario. Solo lectura.|
|photos|Colección de [fotografías](photo.md)| Solo lectura. Admite valores NULL.|
|planner|[plannerUser](planneruser.md)| Servicios de organizador selectivos disponibles para el usuario. Solo lectura. Admite valores NULL. |
|SharePoint|[SharePoint](sharepoint.md)| Acceso al sitio de SharePoint del usuario. Solo lectura. |
|scopedRoleMemberOf|colección de [scopedRoleMembership](scopedrolemembership.md)| Las pertenencias de rol con ámbito de unidad administrativa para este usuario. Solo lectura. Admite valores NULL.|
|settings|colección de [configuraciones](user-settings.md)| Solo lectura. Admite valores NULL.|

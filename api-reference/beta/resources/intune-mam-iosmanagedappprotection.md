...
|allowedIosDeviceModels|String|Permite la lista de modelos de dispositivo separados de punto y coma, como una cadena, para la aplicación administrada para que funcione.|
...
|thirdPartyKeyboardsBlocked|Boolean|Define si se permiten que los teclados de otros fabricantes al tener acceso a una aplicación administrada|
...
|disableProtectionOfManagedOutboundOpenInData|Boolean|Deshabilitar la protección de datos que se transfieren a otras aplicaciones a través de la opción de apertura de IOS. Esta configuración sólo se permite que sea True cuando AllowedOutboundDataTransferDestinations está establecido en ManagedApps.|
|protectInboundDataFromUnknownSources|Boolean|Proteger los datos entrantes de origen desconocido. Esta configuración sólo se permite que sea True cuando AllowedInboundDataTransferSources está establecido en AllApps.|

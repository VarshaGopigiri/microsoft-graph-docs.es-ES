# <a name="authenticate-microsoft-graph-apps-with-the-azure-ad-v20-endpoint"></a>Autenticar aplicaciones de Microsoft Graph con el punto de conexión v2.0 de Azure AD

...
- Para autenticar los usuarios con cuentas personales de Microsoft, tales como las de _live.com_ o _outlook.com_, use el [punto de conexión de Azure Active Directory (AD Azure) v2.0](converged_auth.md).
- Para autenticar los usuarios con cuentas empresariales (es decir, profesionales o educativas), use [Azure AD](app_authorization.md).
...
<table style="width:100%">
  ...
  <tr>
    <td>Directivas del dispositivo de acceso condicional</td>
     <td><a href="https://azure.microsoft.com/en-us/documentation/articles/active-directory-conditional-access-device-policies/" target="_newtab">Admitido</a></td> 
  ...
  <tr>
    ...
    <td><a href ="https://azure.microsoft.com/en-us/documentation/articles/active-directory-v2-compare/#scopes-not-resources" target="_newtab">Dinámico</a> Solicitud durante la ejecución de la aplicación; incluye consentimiento incremental</td>
  </tr>
  <tr>
...
En la sección [Introducción](http://developer.microsoft.com/en-us/graph/docs/platform/get-started), se incluyen artículos detallados en los que se muestra cómo crear las aplicaciones que se enumeran en la tabla mediante el punto de conexión v2.0 de Azure AD y se incluyen las bibliotecas de autenticación de cada plataforma. 

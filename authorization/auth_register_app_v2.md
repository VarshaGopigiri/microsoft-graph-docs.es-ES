# <a name="register-your-microsoft-graph-application-with-the-azure-ad-v20-endpoint"></a>Registrar su aplicación de Microsoft Graph con el punto de conexión v2.0 de Azure AD
